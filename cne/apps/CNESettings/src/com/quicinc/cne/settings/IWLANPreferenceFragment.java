...
import com.quicinc.cne.settings.controllers.IWLANController;

public class IWLANPreferenceFragment extends BasePreferenceFragment {
    protected BaseController getController(Context context, PreferenceScreen preferencesScreen){
        return (new IWLANController(context, preferencesScreen));
    }

    protected int getPreferencesResId(){
        return R.xml.preference_iwlan;
    }
}
