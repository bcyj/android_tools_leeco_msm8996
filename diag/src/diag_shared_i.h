...
#define DIAG_PERIPH_STREAMING_MODE		0
#define DIAG_PERIPH_THRESHOLD_BUFFERING_MODE	1
#define DIAG_PERIPH_CIRCULAR_BUFFERING_MODE	2

#define DIAG_PERIPH_MODEM	0
#define DIAG_PERIPH_ADSP	1
#define DIAG_PERIPH_WCNSS	2
#define DIAG_PERIPH_SENSORS	3
#define DIAG_PERIPH_LAST	DIAG_PERIPH_SENSORS
