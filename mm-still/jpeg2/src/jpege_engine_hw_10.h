...
typedef struct
{
    ...
    jpege_hw_obj_t                     gmn_obj;        // Gemini object
    int                           jpege_hw_fd;         // FD of gemini object
    ...
    jpeg_buf_t                   *p_input_cr;     //Input CR buffer for 3 planaer input
    uint32_t                      luma_width;     // Input Luma Width
    uint32_t                      luma_height;    // Input Luma Height
    uint32_t                      chroma_width;   //Input Chroma height
    uint32_t                      chroma_height;  //Input Chroma height
    ...
    JPEGE_HW_INPUT_FORMAT           color_format; //To support differnt color formats
    jpege_scale_cfg_t             scale_cfg;    //Scaling parameters
    uint32_t                      padding; //Any additional padding added to the buffers
    uint16_t                      num_of_input_planes;
