                             ...
                             uint32_t              image_id)
{
    ...
    exif_tag_entry_ex_t **pp_entries = (exif_tag_entry_ex_t **)&p_mpo_attribute[image_id];
                          ...
                          uint32_t             image_id)
{
    ...
    // Determine if the entry is present or not
    pp_tag_entry = (exif_tag_entry_ex_t **)&p_attribute[image_id] + tag_offset;
  ...
  uint32_t           src_id)
{
    ...
    pp_tag_entry = (exif_tag_entry_ex_t **)p_info + tag_offset +
      MPO_INDEX_IFD_SIZE + src_id * MPO_ATTRIBUTE_IFD_SIZE;
