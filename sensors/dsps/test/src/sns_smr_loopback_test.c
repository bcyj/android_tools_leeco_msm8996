/******************************************************************************
  @file  sns_pmr_loopback_test.c
  @brief Test program for SMR loopback

  DESCRIPTION
  Program to test the working of SMR loopback port between APPS and DSPS.
  The program is expected to be invoked at SMR level.
...
/*============================================================================
  ...
  $Header: //source/qcom/qct/core/sensors/dsps/apps/lasim/main/latest/test/src/sns_smr_loopback_test.c#3 $
  $DateTime: 2011/06/01 18:56:46 $

  when       who    what, where, why 
  ---------- --- -----------------------------------------------------------
  2011-05-27 br  Limited the packet size to 512 bytes as SMR only supports up to 62x bytes
  2011-05-10 agk Used smd_pkt_loopback_test code as reference and modified it 
                 for testing SMR (between Apps - DSPS) in loopback mode.
				 [Reference smd_pkt_loopback_test.c was picked from 8660 LA CP3
				 build : <root>/vendor/qcom/proprietary/kernel-tests/smd]
===============================================================================*/
...
#define SMD_DEV_NM   "/dev/smd_sns_dsps"
...
/* Only packet sizes up to 512 bytes are supported right now by SMR*/
