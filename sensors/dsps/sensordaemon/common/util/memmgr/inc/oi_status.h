...
typedef enum {
    ...
    OI_STATUS_SOME_Q_ERROR                 = 149, /**< Indeterminite error from some call to external Qualcomm process */
    ...
    OI_L2CAP_LOCKSTEP_CONFIG_FAIL          = 509, /**< L2CAP: Lockstep config failed */
    ...
    OI_BLST_ACKNOWLDGE_TIMEOUT             = 2802, /**< BLST: Timeout expired while waiting for an event acknowledgment from the client */
    ...
    OI_AMP_NO_RESPONSE                     = 3401, /**< AMP: No response to signalling request */
    OI_AMP_RECV_LENGTH                     = 3402, /**< AMP: Recevied signaling message with incorrect number of bytes. */
    OI_AMP_BAD_RECV                        = 3403, /**< AMP: Received improperly formatted signaling message */
    OI_AMP_UNEXPECTED_RECV                 = 3404, /**< AMP: Received a signaling response for non-existent request */
    ...
    OI_AMP_DISCONNECT                      = 3418, /**< AMP: Request failed due to disconnection or AMP or ER/BDR link */
    ...
    OI_STATUS_RESERVED_FOR_BHAPI           = 9200, /**< Status code values reserved for BHAPI products */    
