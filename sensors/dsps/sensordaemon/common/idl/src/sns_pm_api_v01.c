...
static const qmi_idl_service_message_table_entry SNS_PM_SVC_service_command_messages_v01[] = {
  {SNS_PM_CANCEL_REQ_V01, TYPE16(1, 0), 0},
  {SNS_PM_VERSION_REQ_V01, TYPE16(1, 2), 0},
  {SNS_PM_ACTIVE_PWR_ST_CHANGE_REQ_V01, TYPE16(0, 0), 4}
};

static const qmi_idl_service_message_table_entry SNS_PM_SVC_service_response_messages_v01[] = {
  {SNS_PM_CANCEL_RESP_V01, TYPE16(1, 1), 5},
  {SNS_PM_VERSION_RESP_V01, TYPE16(1, 3), 17},
  {SNS_PM_ACTIVE_PWR_ST_CHANGE_RESP_V01, TYPE16(0, 1), 5}
};

static const qmi_idl_service_message_table_entry SNS_PM_SVC_service_indication_messages_v01[] = {
  {SNS_PM_ACTIVE_PWR_ST_CHANGE_IND_V01, TYPE16(0, 2), 4}
};

/*Service Object*/
const struct qmi_idl_service_object SNS_PM_SVC_qmi_idl_service_object_v01 = {
  0x04,
  0x01,
