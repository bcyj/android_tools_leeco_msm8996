/*============================================================================
  @file VehicleMotionDetector.h

  @brief
  VehicleMotionDetector class definition.

  Copyright (c) 2014 Qualcomm Technologies, Inc.  All Rights Reserved.
  Qualcomm Technologies Proprietary and Confidential.
============================================================================*/
#ifndef ANDROID_VMD_SENSOR_H
#define ANDROID_VMD_SENSOR_H
...
class VehicleMotionDetector : public SAMSensor {

public:
    VehicleMotionDetector(int handle);
