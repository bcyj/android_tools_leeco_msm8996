/*============================================================================
  @file PedestrianActivityMonitor.h

  @brief
  PedestrianActivityMonitor class definition.

  Copyright (c) 2014 Qualcomm Technologies, Inc.  All Rights Reserved.
  Qualcomm Technologies Proprietary and Confidential.
============================================================================*/
#ifndef ANDROID_PAM_SENSOR_H
#define ANDROID_PAM_SENSOR_H

#include "SAMSensor.h"
#include "sns_sam_pam_v01.h"

/*============================================================================
 * Class PedestrianActivityMonitor
=============================================================================*/

class PedestrianActivityMonitor : public SAMSensor {

public:
    PedestrianActivityMonitor(int handle);
    ~PedestrianActivityMonitor();
    int enable(int en);
/*===========================================================================
