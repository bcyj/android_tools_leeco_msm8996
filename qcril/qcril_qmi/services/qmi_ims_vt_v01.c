...
static const qmi_idl_service_message_table_entry ims_qmi_service_command_messages_v01[] = {
  {IMS_VT_DIAL_CALL_REQ_V01, TYPE16(0, 0), 91},
  {IMS_VT_END_CALL_REQ_V01, TYPE16(0, 2), 4},
  {IMS_VT_ANSWER_CALL_REQ_V01, TYPE16(0, 4), 11},
