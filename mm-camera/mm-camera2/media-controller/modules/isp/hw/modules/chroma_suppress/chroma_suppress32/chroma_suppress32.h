...
============================================================================*/
#ifndef __CHROMA_SUPPRESS32_H__
#define __CHROMA_SUPPRESS32_H__

#include "camera_dbg.h"
#include "isp_event.h"
#include "chroma_suppress32_reg.h"
...
typedef struct {
  ...
  ISP_ChromaSuppress_Mix1_ConfigCmdType applied_reg_cmd;
}isp_chroma_suppress_mix_1_cmd_t;

typedef struct {
  uint32_t hw_mask;
  ISP_ChromaSuppress_Mix2_ConfigCmdType reg_cmd;
  ISP_ChromaSuppress_Mix2_ConfigCmdType applied_reg_cmd;
...
typedef struct {
  ...
  ISP_ChromaSuppress_ConfigCmdType applied_reg_cmd;
