...
============================================================================*/
#ifndef __AWB_STATS_REG_H__
#define __AWB_STATS_REG_H__

#define AWB_STATS_OFF 0x000008C4
#define AWB_STATS_LEN 8

#define ISP_STATS_AWB_BUF_NUM 4
#define ISP_STATS_AWB_BUF_SIZE 1040 * 4 //(membory size by bytes)
