  ...
  uint32_t in_param_size)
{
  ...
  pcmd->a00        = pix_settings->stats_cfg.af_config.hpf[0];
  pcmd->a01        = pix_settings->stats_cfg.af_config.hpf[1];
  pcmd->a02        = pix_settings->stats_cfg.af_config.hpf[2];
  pcmd->a03        = pix_settings->stats_cfg.af_config.hpf[3];
  pcmd->a04        = pix_settings->stats_cfg.af_config.hpf[4];
  pcmd->a10        = pix_settings->stats_cfg.af_config.hpf[5];
  pcmd->a11        = pix_settings->stats_cfg.af_config.hpf[6];
  pcmd->a12        = pix_settings->stats_cfg.af_config.hpf[7];
  pcmd->a13        = pix_settings->stats_cfg.af_config.hpf[8];
  pcmd->a14        = pix_settings->stats_cfg.af_config.hpf[9];
...
/* update afConfig to reflect the new config    *
  ...
  uint32_t camif_window_h_t = camif_cfg->sensor_out_info.request_crop.last_line -
