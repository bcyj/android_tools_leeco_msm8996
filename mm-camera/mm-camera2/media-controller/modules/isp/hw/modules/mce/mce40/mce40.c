  ...
  isp_pix_trigger_update_input_t *trigger_params, uint32_t in_param_size)
{
  ...
  mce_config->redCfg.K =
  (uint32_t)(fKr * (1 << mce_mod->mce_mix_cmd_2.qk));
  mce_config->greenCfg.K =
  (uint32_t)(fKg * (1 << mce_mod->mce_mix_cmd_2.qk));
  mce_config->blueCfg.K =
  (uint32_t)(fKb * (1 << mce_mod->mce_mix_cmd_2.qk));
                ...
                uint32_t in_param_size)
{
  ...
  mce->mce_mix_cmd_1.enable = mce->mce_enable;
  mce->hw_update_pending = 1;
  return 0;
}
