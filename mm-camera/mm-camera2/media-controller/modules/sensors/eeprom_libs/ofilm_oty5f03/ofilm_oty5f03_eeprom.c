...
#define RG_TYPICAL 0x17F
#define BG_TYPICAL 0x156
...
/** ofilm_oty5f03_get_calibration_items:
 ...
 * Return: void
 **/
void ofilm_oty5f03_get_calibration_items(void *e_ctrl)
{
 ...
 * Return: void
 **/
static void ofilm_oty5f03_format_wbdata(sensor_eeprom_data_t *e_ctrl)
{
...
/** ofilm_oty5f03_format_calibration_data:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 *
 ...
 * Return: void
 **/
void ofilm_oty5f03_format_calibration_data(void *e_ctrl) {
  SLOW("Enter");
  sensor_eeprom_data_t *ectrl = (sensor_eeprom_data_t *)e_ctrl;
  ...
  ofilm_oty5f03_format_wbdata(ectrl);

  SLOW("Exit");
}

/** ofilm_oty5f03_get_raw_data:
 *    @e_ctrl: point to sensor_eeprom_data_t of the eeprom device
 ...
 * Return: void
 **/
void ofilm_oty5f03_get_raw_data(void *e_ctrl, void *data) {
  if (e_ctrl && data)
...
static eeprom_lib_func_t ofilm_oty5f03_lib_func_ptr = {
  .get_calibration_items = ofilm_oty5f03_get_calibration_items,
  .format_calibration_data = ofilm_oty5f03_format_calibration_data,
  .do_af_calibration = NULL,
  .do_wbc_calibration = NULL,
  .do_lsc_calibration = NULL,
  .do_dpc_calibration = NULL,
  .get_dpc_calibration_info = NULL,
  .get_raw_data = ofilm_oty5f03_get_raw_data,
};

/** ofilm_oty5f03_eeprom_open_lib:
 *
 ...
 **/
void* ofilm_oty5f03_eeprom_open_lib(void) {
  return &ofilm_oty5f03_lib_func_ptr;
}
