S5K4E1_SKUHF_SENSOR_LIBS_PATH := $(call my-dir)
...
include $(CLEAR_VARS)
LOCAL_PATH := $(S5K4E1_SKUHF_SENSOR_LIBS_PATH)
...
LOCAL_SRC_FILES:= s5k4e1_skuhf_lib.c
LOCAL_MODULE           := libmmcamera_S5K4E1_SKUHF
