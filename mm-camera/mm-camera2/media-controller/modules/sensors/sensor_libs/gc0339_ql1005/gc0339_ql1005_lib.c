...
#define SENSOR_MODEL_NO_GC0339 "gc0339_ql1005"
...
static struct msm_camera_sensor_slave_info sensor_slave_info = {
  ...
  .sensor_id_info = {
    ...
    /* sensor id */
    /*For gc0339, The real chip id is 0xc8, it needs to write 0x10 to address 0xfc first*/
    .sensor_id = 0x0, //0xc8
  },
  ...
  struct msm_camera_i2c_reg_setting *reg_setting)
{
  ...
  reg_setting->reg_setting[reg_count].reg_data = (line& 0xF00) >> 8 ;
  reg_count++;
 ...
 * DESCRIPTION:
 *==========================================================================*/
void *gc0339_ql1005_open_lib(void)
{
