...
#define SENSOR_MODEL_NO_OV5670_QC700 "ov5670_qc700"
#define OV5670_QC700_LOAD_CHROMATIX(n) \
  "libchromatix_"SENSOR_MODEL_NO_OV5670_QC700"_"#n".so"
...
static struct msm_sensor_power_setting ov5670_qc700_power_setting[] = {
    {
...
static struct msm_camera_sensor_slave_info sensor_slave_info = {
  ...
  .power_setting_array = {
    .power_setting = ov5670_qc700_power_setting,
    .size = ARRAY_SIZE(ov5670_qc700_power_setting),
  },
...
static struct msm_camera_csid_vc_cfg ov5670_qc700_cid_cfg[] = {
  {0, CSI_RAW10, CSI_DECODE_10BIT},
  {1, CSI_EMBED_DATA, CSI_DECODE_8BIT},
};

static struct msm_camera_csi2_params ov5670_qc700_csi_params = {
  .csid_params = {
    .lane_cnt = 2,
    .lut_params = {
      .num_cid = ARRAY_SIZE(ov5670_qc700_cid_cfg),
      .vc_cfg = {
         &ov5670_qc700_cid_cfg[0],
         &ov5670_qc700_cid_cfg[1],
      },
    },
  },
  .csiphy_params = {
...
static struct sensor_pix_fmt_info_t ov5670_qc700_pix_fmt0_fourcc[] = {
  { V4L2_PIX_FMT_SBGGR10 },
};

static struct sensor_pix_fmt_info_t ov5670_qc700_pix_fmt1_fourcc[] = {
  { MSM_V4L2_PIX_FMT_META },
};

static sensor_stream_info_t ov5670_qc700_stream_info[] = {
  {1, &ov5670_qc700_cid_cfg[0], ov5670_qc700_pix_fmt0_fourcc},
  {1, &ov5670_qc700_cid_cfg[1], ov5670_qc700_pix_fmt1_fourcc},
};

static sensor_stream_info_array_t ov5670_qc700_stream_info_array = {
  .sensor_stream_info = ov5670_qc700_stream_info,
  .size = ARRAY_SIZE(ov5670_qc700_stream_info),
};
...
static struct msm_camera_csi2_params *csi_params[] = {
  &ov5670_qc700_csi_params, /* RES 0*/
  &ov5670_qc700_csi_params, /* RES 1*/
  &ov5670_qc700_csi_params, /* RES 2*/
};
...
static sensor_res_cfg_type_t ov5670_qc700_res_cfg[] = {
...
static struct sensor_res_cfg_table_t ov5670_qc700_res_table = {
  .res_cfg_type = ov5670_qc700_res_cfg,
  .size = ARRAY_SIZE(ov5670_qc700_res_cfg),
};

static struct sensor_lib_chromatix_t ov5670_qc700_chromatix[] = {
#if SNAPSHOT_PARAM
  {
    .common_chromatix = OV5670_QC700_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = OV5670_QC700_LOAD_CHROMATIX(zsl), /* RES0 */
    .camera_snapshot_chromatix = OV5670_QC700_LOAD_CHROMATIX(snapshot), /* RES0 */
    .camcorder_chromatix = OV5670_QC700_LOAD_CHROMATIX(default_video), /* RES0 */
    .liveshot_chromatix =  OV5670_QC700_LOAD_CHROMATIX(liveshot), /* RES0 */
  },
#endif
#if PREVIEW_PARAM
  {
    .common_chromatix = OV5670_QC700_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = OV5670_QC700_LOAD_CHROMATIX(preview), /* RES1 */
    .camera_snapshot_chromatix = OV5670_QC700_LOAD_CHROMATIX(preview), /* RES1 */
    .camcorder_chromatix = OV5670_QC700_LOAD_CHROMATIX(default_video), /* RES1 */
    .liveshot_chromatix =  OV5670_QC700_LOAD_CHROMATIX(liveshot), /* RES1 */
  },
#endif
#if VIDEO_1080P_PARAM
  {
    .common_chromatix = OV5670_QC700_LOAD_CHROMATIX(common),
    .camera_preview_chromatix = OV5670_QC700_LOAD_CHROMATIX(video_hd), /* RES2 */
    .camera_snapshot_chromatix = OV5670_QC700_LOAD_CHROMATIX(video_hd), /* RES2 */
    .camcorder_chromatix = OV5670_QC700_LOAD_CHROMATIX(video_hd), /* RES2 */
    .liveshot_chromatix =  OV5670_QC700_LOAD_CHROMATIX(liveshot), /* RES2 */
  },
#endif
};

static struct sensor_lib_chromatix_array ov5670_qc700_lib_chromatix_array = {
  .sensor_lib_chromatix = ov5670_qc700_chromatix,
  .size = ARRAY_SIZE(ov5670_qc700_chromatix),
};

/*===========================================================================
 * FUNCTION    - ov5670_qc700_real_to_register_gain -
 *
 * DESCRIPTION:
 *==========================================================================*/
static uint16_t ov5670_qc700_real_to_register_gain(float gain)
{
  uint16_t reg_gain;
...
/*===========================================================================
 * FUNCTION    - ov5670_qc700_register_to_real_gain -
 *
 * DESCRIPTION:
 *==========================================================================*/
static float ov5670_qc700_register_to_real_gain(uint16_t reg_gain)
{
  float real_gain;
...
/*===========================================================================
 * FUNCTION    - ov5670_qc700_calculate_exposure -
 *
 * DESCRIPTION:
 *==========================================================================*/
static int32_t ov5670_qc700_calculate_exposure(float real_gain,
  uint16_t line_count, sensor_exposure_info_t *exp_info)
{
  if (!exp_info) {
    return -1;
  }
  exp_info->reg_gain = ov5670_qc700_real_to_register_gain(real_gain);
  exp_info->sensor_real_gain = ov5670_qc700_register_to_real_gain(exp_info->reg_gain);
...
/*===========================================================================
 * FUNCTION    - ov5670_qc700_fill_exposure_array -
 *
 * DESCRIPTION:
 *==========================================================================*/
static int32_t ov5670_qc700_fill_exposure_array(uint16_t gain, uint32_t line,
...
static sensor_exposure_table_t ov5670_qc700_expsoure_tbl = {
  .sensor_calculate_exposure = ov5670_qc700_calculate_exposure,
  .sensor_fill_exposure_array = ov5670_qc700_fill_exposure_array,
};
...
static sensor_lib_t sensor_lib_ptr = {
  ...
  /* csi cid params */
  .csi_cid_params = ov5670_qc700_cid_cfg,
  /* csi csid params array size */
  .csi_cid_params_size = ARRAY_SIZE(ov5670_qc700_cid_cfg),
  /* init settings */
  ...
  .sensor_res_cfg_table = &ov5670_qc700_res_table,
  /* res settings */
  ...
  .sensor_stream_info_array = &ov5670_qc700_stream_info_array,
  /* exposure funtion table */
  .exposure_func_table = &ov5670_qc700_expsoure_tbl,
  /* chromatix array */
  .chromatix_array = &ov5670_qc700_lib_chromatix_array,
...
/*===========================================================================
 * FUNCTION    - ov5670_qc700_open_lib -
 *
 * DESCRIPTION:
 *==========================================================================*/
void *ov5670_qc700_open_lib(void)
{
