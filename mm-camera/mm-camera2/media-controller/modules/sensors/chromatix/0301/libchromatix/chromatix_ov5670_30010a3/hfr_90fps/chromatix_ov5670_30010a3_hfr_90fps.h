...
/*********************************************************************/
      ...
      {
         1.9797f,    -0.8926f,    -0.0871f,
         -0.2384f,    1.5955f,    -0.3571f,
         -0.0343f,    -0.6431f,    1.6774f,
         0,    0,    0,
         0
      },
      /* A Color Correction */
...
/*********************************************************************/
      ...
      /* D65 Color Conversion */
      {
         {
            /* a_m, a_p */
            0.5486f*1.03, 0.5486f*1.03,
            /* b_m, b_p */
            -0.3504f, -0.3504f,
            /* c_m, c_p */
            0.5519f*1.03, 0.5519f*1.03,
            /* d_m, d_p */
            -0.1379f, -0.1379f,
            /* k_cb, k_cr */
            128, 128
...
/******************************************************************************/
         ...
         /* Reference Noise */
         {
            /* Noise Profile 1 */
            {
               ...
               {
                  4.50000f, 4.000000f, 4.000000f, 4.000000f
               },
               ...
               /* Denoise Weight Y */
               {
                  0.062500f, 0.250000f, 0.375000f, 0.25000f
               },
            ...
            /* Noise Profile 2 */
            {
               ...
               /* Denoise Edge Softness Y */
               {
                  4.500000f, 4.000000f, 4.000000f, 3.500000f
               },
               /* Denoise Edge Softness Chroma */
               {
                  8.500000f, 8.500000f, 8.500000f, 8.500000f
               ...
               /* Denoise Weight Y */
               {
                  0.06250f, 0.250000f, 0.325000f, 0.325000f
               },
               /* Denoise Weight Chroma */
               {
                  0.000000f, 0.000000f, 0.000000f, 0.000000f
            ...
            /* Noise Profile 3 */
            {
               ...
               /* Denoise Weight Y */
               {
                  0.125000f, 0.2500f, 0.325000f, 0.325000f
               },
               /* Denoise Weight Chroma */
               {
                  0.000000f, 0.000000f, 0.000000f, 0.000000f
            ...
            /* Noise Profile 4 */
            {
               ...
               /* Denoise Weight Y */
               {
                   0.062500f, 0.12500f, 0.250000f, 0.125000f
               },
               /* Denoise Weight Chroma */
               {
                  0.000000f, 0.000000f, 0.000000f, 0.000000f
            ...
            /* Noise Profile 5 */
            {
               ...
               /* Denoise Weight Y */
               {
                  0.062500f, 0.12500f, 0.250000f, 0.250000f
               },
               /* Denoise Weight Chroma */
               {
                  0.000000f, 0.000000f, 0.000000f, 0.000000f
            ...
            /* Noise Profile 6 */
            {
               ...
               /* Denoise Edge Softness Y */
               {
                  7.000000f, 6.500000f, 6.500000f, 6.500000f
               },
               /* Denoise Edge Softness Chroma */
               {
               ...
               /* Denoise Weight Y */
               {
                   0.065000f, 0.12500f, 0.325000f, 0.250000f
               },
               /* Denoise Weight Chroma */
               {
                  0.000000f, 0.000000f, 0.000000f, 0.000000f
...
/*********************************************************************/
   ...
   /* AWB Reference Points w/HW */
   {
      ...
      /* A AWB Reference Point */
      {
 0.883f,//.884000f,    /* R/G ratio */
 0.426f,//.446000f,    /* B/G ratio */
      },
      /* TL84 AWB Reference Point */
      {
         0.761200f,    /* R/G ratio */
      ...
      {
         0.653000f,    /* R/G ratio */
  0.470f,//0.5070f,    /* B/G ratio */
      },
      /* Horizon AWB Reference Point */
      {
         1.043500f,    /* R/G ratio */
 0.418f,//.408400f,    /* B/G ratio */
      },
      /* D50 AWB Reference Point */
      {
         0.621000f,    /* R/G ratio */
...
/******************************************************************************/
   ...
   /* Lowlight LUT */
   {
      1, /* Enable */
      {
         ...
         {
            292, /* Lux Index */
            -50.75225f, /* Green RG Offset Adj */
            -50.88142f, /* Green BG Offset Adj */
            0.143256f, /* Outlier Dist Adj */
         },
         /* Entry 2 */
         {
            314, /* Lux Index */
            -100.9768f, /* Green RG Offset Adj */
            -100.6989f, /* Green BG Offset Adj */
            0.020343f, /* Outlier Dist Adj */
         },
         /* Entry 3 */
         {
            344, /* Lux Index */
            -100.2254f, /* Green RG Offset Adj */
            -100.0369f, /* Green BG Offset Adj */
            2.418315f, /* Outlier Dist Adj */
         },
         /* Entry 4 */
         {
            365, /* Lux Index */
            -100.2254f, /* Green RG Offset Adj */
            -100.3489f, /* Green BG Offset Adj */
            2.161658f, /* Outlier Dist Adj */
         },
         /* Entry 5 */
         {
            380, /* Lux Index */
...
/*********************************************************************/
   ...
   /* Exposure Table */
   {
      ...
      352, /* Max Exposure Table Entries for EV+2 with digital gain */
      {
         ...
         {2560, 668},    /* Gain=10.000    Exposure Index=298    */
         {2637, 668},    /* Gain=10.301    Exposure Index=299    */
         {2716, 668},    /* Gain=10.609    Exposure Index=300    */
         {2797, 668},    /* Gain=10.926    Exposure Index=301    */
         {2881, 668},    /* Gain=11.254    Exposure Index=302    */
         {2967, 668},    /* Gain=11.590    Exposure Index=303    */
         {3056, 668},    /* Gain=11.938    Exposure Index=304    */
         {3072, 668},    /* Gain=12.000    Exposure Index=305    */
         {3164, 668},    /* Gain=12.359    Exposure Index=306    */
         {3259, 668},    /* Gain=12.730    Exposure Index=307    */
         {3357, 668},    /* Gain=13.113    Exposure Index=308    */
         {3458, 668},    /* Gain=13.508    Exposure Index=309    */
         {3562, 668},    /* Gain=13.914    Exposure Index=310    */
         {3669, 668},    /* Gain=14.332    Exposure Index=311    */
         {3779, 668},    /* Gain=14.762    Exposure Index=312    */
         {3892, 668},    /* Gain=15.203    Exposure Index=313    */
         {4009, 668},    /* Gain=15.660    Exposure Index=314    */
         {4129, 668},    /* Gain=16.129    Exposure Index=315    */
         {4253, 668},    /* Gain=16.613    Exposure Index=316    */
         {4381, 668},    /* Gain=17.113    Exposure Index=317    */
         {4512, 668},    /* Gain=17.625    Exposure Index=318    */
         {4647, 668},    /* Gain=18.152    Exposure Index=319    */
         {4786, 668},    /* Gain=18.695    Exposure Index=320    */
         {4930, 668},    /* Gain=19.258    Exposure Index=321    */
         {5078, 668},    /* Gain=19.836    Exposure Index=322    */
         {5230, 668},    /* Gain=20.430    Exposure Index=323    */
         {5387, 668},    /* Gain=21.043    Exposure Index=324    */
         {5549, 668},    /* Gain=21.676    Exposure Index=325    */
         {5715, 668},    /* Gain=22.324    Exposure Index=326    */
         {5886, 668},    /* Gain=22.992    Exposure Index=327    */
         {6063, 668},    /* Gain=23.684    Exposure Index=328    */
         {6245, 668},    /* Gain=24.395    Exposure Index=329    */
         {6432, 668},    /* Gain=25.125    Exposure Index=330    */
         {6625, 668},    /* Gain=25.879    Exposure Index=331    */
         {6824, 668},    /* Gain=26.656    Exposure Index=332    */
         {7029, 668},    /* Gain=27.457    Exposure Index=333    */
         {7240, 668},    /* Gain=28.281    Exposure Index=334    */
         {7457, 668},    /* Gain=29.129    Exposure Index=335    */
         {7681, 668},    /* Gain=30.004    Exposure Index=336    */
         {7911, 668},    /* Gain=30.902    Exposure Index=337    */
         {8148, 668},    /* Gain=31.828    Exposure Index=338    */
         {8392, 668},    /* Gain=32.781    Exposure Index=339    */
         {8644, 668},    /* Gain=33.766    Exposure Index=340    */
         {8903, 668},    /* Gain=34.777    Exposure Index=341    */
         {9170, 668},    /* Gain=35.820    Exposure Index=342    */
         {9445, 668},    /* Gain=36.895    Exposure Index=343    */
         {9728, 668},    /* Gain=38.000    Exposure Index=344    */
         {10020, 668},    /* Gain=39.141    Exposure Index=345    */
         {10321, 668},    /* Gain=40.316    Exposure Index=346    */
         {10631, 668},    /* Gain=41.527    Exposure Index=347    */
         {10950, 668},    /* Gain=42.773    Exposure Index=348    */
         {11279, 668},    /* Gain=44.059    Exposure Index=349    */
         {11617, 668},    /* Gain=45.379    Exposure Index=350    */
         {11966, 668}    /* Gain=46.742    Exposure Index=351    */
      },
   },
...
/******************************************************************************/
   ...
   1.200000f, /* AEC LED Snapshot Flux Hi */
