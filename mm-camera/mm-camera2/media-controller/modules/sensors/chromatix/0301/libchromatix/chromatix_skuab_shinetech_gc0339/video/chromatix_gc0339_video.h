...
/******************************************************************************/
      ...
      /* ABF2 Low Light */
      {
         ...
         {
            1.000000f, 1.000000f, 1.000000f, 1.000000f,
            1.000000f, 0.924381f, 0.800217f, 0.676054f,
            0.621906f, 0.505784f, 0.404109f, 0.281764f,
            0.261095f, 0.175176f, 0.092814f, 0.055866f
         },
         /* Negative table */
         {
            -0.259048f, -0.965336f, -0.984840f, -0.570242f,
            -0.518529f, -0.284811f, -0.181445f, -0.022111f
         },
      },
      /* ABF2 Normal Light */
      {
         ...
         {
            1.000000f, 1.000000f, 1.000000f, 1.000000f,
            1.000000f, 1.000000f, 0.926827f, 0.887128f,
            0.740782f, 0.661383f, 0.515038f, 0.435639f,
            0.313932f, 0.248863f, 0.151796f, 0.077893f
         },
         /* Negative table */
         {
            -0.273857f, -1.000000f, -0.835670f, -0.324324f,
            -0.550261f, -0.115668f, -0.115308f, -0.065347f
         },
      },
      /* ABF2 Bright Light */
      {
         ...
         /* Positive table */
         {
            ...
            1.000000f, 1.000000f, 1.000000f, 1.000000f,
            1.000000f, 1.000000f, 1.000000f, 1.000000f,
            0.884851f, 0.884851f, 0.884851f, 0.769702f
         },
         /* Negative table */
         {
            -0.128799f, -1.000000f, -0.704077f, -0.374723f,
            -0.384627f, -0.094681f, -0.095276f, -0.046317f
         },
      },
   },
...
/******************************************************************************/
      ...
      /* Luma Filter Low Light */
      {
         ...
         /* Positive table */
         {
            ...
            0.692162f, 0.692162f, 0.486936f, 0.486936f,
            0.319278f, 0.319278f, 0.189186f, 0.124140f
         },
         /* Negative table */
         {
            -0.034149f, -1.000000f, -0.980831f, -0.379517f,
            -0.418287f, -0.227434f, -0.055020f, -0.072641f
         },
      },
...
/*********************************************************************/
      ...
      {
         1.6518f,    -0.2696f,    -0.3822f,
         -0.0364f,    1.1488f,    -0.1124f,
         0.0119f,    -0.6622f,    1.6502f,
         0,    0,    0,
         0
      },
...
/*********************************************************************/
      ...
      /* Low-Light Color Correction */
      {
         1.4949f,    -0.1408f,    -0.3541f,
         -0.1308f,    1.3083f,    -0.1775f,
         -0.0734f,    -0.5250f,    1.5984f,
         0,    0,    0,
         0
      },
      /* D65 Color Correction */
      {
         1.4087f,    0.0137f,    -0.4224f,
         -0.3044f,    1.8167f,    -0.5123f,
         -0.1450f,    -0.2466f,    1.3917f,
         0,    0,    0,
         0
      },
      /* A Color Correction */
      {
         1.3690f,    0.3927f,    -0.7617f,
         -0.1839f,    1.2507f,    -0.0667f,
         -0.2353f,    -0.4612f,    1.6965f,
         0,    0,    0,
         0
      },
...
/*********************************************************************/
   ...
   {1.083000f, 1.000000f, 1.151000f},
   /* D50 Whitebalance - RGB */
   {1.331000f, 1.088000f, 1.010000f},
   /* A Whitebalance - RGB */
   {1.000000f, 1.124000f, 1.712000f},
   /* D65 Whitebalance - RGB */
   {1.900000f, 1.323000f, 1.000000f},
...
/******************************************************************************/
   ...
   65, /* F Cluster Threshold */
   70, /* Day Cluster Threshold */
...
/******************************************************************************/
   ...
   /* Lowlight LUT */
   {
      1, /* Enable */
      {
         ...
         {
            1, /* Lux Index */
            -2.443075f, /* Green RG Offset Adj */
            -4.789549f, /* Green BG Offset Adj */
            5.376653f, /* Outlier Dist Adj */
         },
         /* Entry 2 */
         {
            2, /* Lux Index */
            -7.800941f, /* Green RG Offset Adj */
            -7.355687f, /* Green BG Offset Adj */
            10.721978f, /* Outlier Dist Adj */
         },
         /* Entry 3 */
         {
            3, /* Lux Index */
         ...
         {
            3, /* Lux Index */
            -12.139974f, /* Green RG Offset Adj */
            -7.355687f, /* Green BG Offset Adj */
            12.326553f, /* Outlier Dist Adj */
         },
         /* Entry 5 */
         {
            4, /* Lux Index */
            -44.325115f, /* Green RG Offset Adj */
            -7.355687f, /* Green BG Offset Adj */
            44.717392f, /* Outlier Dist Adj */
         },
      },
   },
...
/******************************************************************************/
   ...
   1.705839f, /* Ref B BG Tl84 */
   3.417967f, /* Ref R RG A */
   ...
   0.429659f, /* Slope Factor M */
   2.418975f, /* Extreme MCC Blue Threshold */
},
/* AEC */
{
   0, /* Software Type */
...
/*********************************************************************/
   ...
   /* Exposure Table */
   {
      1, /* Use Digital Gain */
      /* Exposure Table */
      302, /* Max Exposure Table entries */
      0, /* Exp Index for Digital Gain for EV Lowlight */
      302, /* Enable Digital Gain for EV Lowlight */
      {
          ...
          {512, 500},   /* Gain= 2.000   Exposure Index=234   */
          {512, 515},   /* Gain= 2.000   Exposure Index=235   */
          {512, 530},   /* Gain= 2.000   Exposure Index=236   */
          {512, 545},   /* Gain= 2.000   Exposure Index=237   */
          {512, 561},   /* Gain= 2.000   Exposure Index=238   */
          {512, 577},   /* Gain= 2.000   Exposure Index=239   */
          {512, 594},   /* Gain= 2.000   Exposure Index=240   */
          {512, 611},   /* Gain= 2.000   Exposure Index=241   */
          {512, 629},   /* Gain= 2.000   Exposure Index=242   */
          {512, 647},   /* Gain= 2.000   Exposure Index=243   */
          {512, 666},   /* Gain= 2.000   Exposure Index=244   */
          {512, 685},   /* Gain= 2.000   Exposure Index=245   */
          {512, 705},   /* Gain= 2.000   Exposure Index=246   */
          {512, 726},   /* Gain= 2.000   Exposure Index=247   */
          {512, 747},   /* Gain= 2.000   Exposure Index=248   */
          {512, 769},   /* Gain= 2.000   Exposure Index=249   */
          {512, 792},   /* Gain= 2.000   Exposure Index=250   */
          {512, 815},   /* Gain= 2.000   Exposure Index=251   */
          {512, 839},   /* Gain= 2.000   Exposure Index=252   */
          {512, 864},   /* Gain= 2.000   Exposure Index=253   */
          {512, 889},   /* Gain= 2.000   Exposure Index=254   */
          {512, 915},   /* Gain= 2.000   Exposure Index=255   */
          {512, 942},   /* Gain= 2.000   Exposure Index=256   */
          {512, 970},   /* Gain= 2.000   Exposure Index=257   */
          {512, 999},   /* Gain= 2.000   Exposure Index=258   */
          {512, 1028},   /* Gain= 2.000   Exposure Index=259   */
          {512, 1058},   /* Gain= 2.000   Exposure Index=260   */
          {512, 1089},   /* Gain= 2.000   Exposure Index=261   */
          {512, 1121},   /* Gain= 2.000   Exposure Index=262   */
          {512, 1154},   /* Gain= 2.000   Exposure Index=263   */
          {512, 1188},   /* Gain= 2.000   Exposure Index=264   */
          {512, 1223},   /* Gain= 2.000   Exposure Index=265   */
          {512, 1259},   /* Gain= 2.000   Exposure Index=266   */
          {512, 1296},   /* Gain= 2.000   Exposure Index=267   */
          {512, 1334},   /* Gain= 2.000   Exposure Index=268   */
          {512, 1374},   /* Gain= 2.000   Exposure Index=269   */
          {512, 1415},   /* Gain= 2.000   Exposure Index=270   */
          {512, 1457},   /* Gain= 2.000   Exposure Index=271   */
          {512, 1500},   /* Gain= 2.000   Exposure Index=272   */
          {512, 1545},   /* Gain= 2.000   Exposure Index=273   */
          {512, 1591},   /* Gain= 2.000   Exposure Index=274   */
          {512, 1638},   /* Gain= 2.000   Exposure Index=275   */
          {512, 1687},   /* Gain= 2.000   Exposure Index=276   */
          {512, 1737},   /* Gain= 2.000   Exposure Index=277   */
          {512, 1789},   /* Gain= 2.000   Exposure Index=278   */
          {524, 1800},   /* Gain= 2.047   Exposure Index=279   */
          {540, 1800},   /* Gain= 2.109   Exposure Index=280   */
          {556, 1800},   /* Gain= 2.172   Exposure Index=281   */
          {573, 1800},   /* Gain= 2.238   Exposure Index=282   */
          {590, 1800},   /* Gain= 2.305   Exposure Index=283   */
          {608, 1800},   /* Gain= 2.375   Exposure Index=284   */
          {626, 1800},   /* Gain= 2.445   Exposure Index=285   */
          {645, 1800},   /* Gain= 2.520   Exposure Index=286   */
          {664, 1800},   /* Gain= 2.594   Exposure Index=287   */
          {684, 1800},   /* Gain= 2.672   Exposure Index=288   */
          {705, 1800},   /* Gain= 2.754   Exposure Index=289   */
          {726, 1800},   /* Gain= 2.836   Exposure Index=290   */
          {748, 1800},   /* Gain= 2.922   Exposure Index=291   */
          {770, 1800},   /* Gain= 3.008   Exposure Index=292   */
          {793, 1800},   /* Gain= 3.098   Exposure Index=293   */
          {817, 1800},   /* Gain= 3.191   Exposure Index=294   */
          {842, 1800},   /* Gain= 3.289   Exposure Index=295   */
          {867, 1800},   /* Gain= 3.387   Exposure Index=296   */
          {893, 1800},   /* Gain= 3.488   Exposure Index=297   */
          {920, 1800},   /* Gain= 3.594   Exposure Index=298   */
          {948, 1800},   /* Gain= 3.703   Exposure Index=299   */
          {976, 1800},   /* Gain= 3.813   Exposure Index=300   */
          {1005, 1800},   /* Gain= 3.926   Exposure Index=301 */
      },
   },
...
/*******************************************************************************/
      ...
      0.765735f, /* RG Ratio lth */
      2.561038f, /* RG Ratio hth */
      0.685188f, /* BG Ratio lth */
