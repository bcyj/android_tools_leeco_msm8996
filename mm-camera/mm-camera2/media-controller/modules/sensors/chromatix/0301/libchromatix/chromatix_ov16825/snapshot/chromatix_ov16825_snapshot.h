...
/*********************************************************************/
      ...
      {
		1.7972f,	-0.8615f,	0.0643f,
		-0.1688f,	1.4156f,	-0.2468f,
		-0.0079f,	-0.4832f,	1.4910f,
         0,    0,    0,
         0
      },
...
/*********************************************************************/
      ...
      /* Saturation: Red - 1.000000, Green - 1.000000, Blue - 1.000000 */
      {
        1.3616f, -0.3611f, -0.0005f,
        -0.1729f, 1.3129f, -0.1400f,
		-0.0920f, -0.2422f, 1.3342f,
		//1.5461f,	-0.5294f,	-0.0167f,
		//-0.2248f,	1.5424f,	-0.3177f,
		//-0.0258f,	-0.5487f,	1.5745f,
         0,    0,    0,
         0
      },
      ...
      /* Saturation: Red - 1.000000, Green - 1.000000, Blue - 1.000000 */
      {
		1.7165f,	-0.7003f,	-0.0162f,
		-0.3227f,	1.7310f,	-0.4083f,
		-0.1063f,	-0.5390f,	1.6453f,
         0,    0,    0,
         0
      },
...
/*********************************************************************/
      ...
      /* Gamma Option: Medium, Weight: 0 */
      {
         {
#if 0
			0,  6,  20,  36,  51,  64, 76,  88,  98,  107,  116,  124,  132,  139,  146,  152,
			158,  164,  169,  174,  178,  182,  186,  190,  194,  198,  201,  204,  207,  209,  212,  214,
			217,  219,  221,  223,  225,  227,  228,  230,  231,  233,  234,  236,  237,  238,  240,  241,
			242,  243,  244,  245,  246,  247,  247,  248,  249,  250,  251,  251,  252,  253,  254,  255
#else
...
/*********************************************************************/
      ...
      /* 7x7 ASF */
      {
         ...
         /* H / Lut1 */
         {
            /* Lowlight */
            {
			   0.0000f*0.4, 0.0000f*0.4, 0.0000f*0.4, 0.0000f*0.4, 0.0000f*0.4, 0.0000f*0.4,
			   0.0000f*0.4, 0.1268f*0.4, 0.2504f*0.4, 0.3676f*0.4, 0.4756f*0.4, 0.5715f*0.4,
               0.6530f*0.4, 0.7180f*0.4, 0.7648f*0.4, 0.7924f*0.4, 0.7998f*0.4, 0.7871f*0.4,
               0.7545f*0.4, 0.7027f*0.4, 0.6333f*0.4, 0.6333f*0.4, 0.6333f*0.4, 0.6333f*0.4
            },
            /* Normal Light */
            {
               0.0000f*0.4, 0.0000f*0.4, 0.0000f*0.4, 0.0000f*0.4, 0.1585f*0.4, 0.3130f*0.4,
			   0.4595f*0.4, 0.5945f*0.4, 0.7144f*0.4, 0.8163f*0.4, 0.8975f*0.4, 0.9561f*0.4,
			   0.9904f*0.4, 0.9998f*0.4, 0.9839f*0.4, 0.9431f*0.4, 0.8784f*0.4, 0.7916f*0.4,
			   0.7916f*0.4, 0.7916f*0.4, 0.7916f*0.4, 0.7916f*0.4, 0.7916f*0.4, 0.7916f*0.4
            },
            /* Bright Light */
            {
               0.0000f*0.6, 0.1902f*0.6, 0.3756f*0.6, 0.5514f*0.6, 0.7134f*0.6, 0.8573f*0.6,
               0.9795f*0.6, 1.0770f*0.6, 1.1473f*0.6, 1.1885f*0.6, 1.1997f*0.6, 1.1806f*0.6,
               1.1317f*0.6, 1.0541f*0.6, 0.9499f*0.6, 0.9499f*0.6, 0.9499f*0.6, 0.9499f*0.6,
               0.9499f*0.6, 0.9499f*0.6, 0.9499f*0.6, 0.9499f*0.6, 0.9499f*0.6, 0.9499f*0.6
            },
         },
         /* V / Lut2 */
         {
...
/******************************************************************************/
      ...
      /* Indoor Luma Adaptation */
      {
         ...
         0, //10, /* Highlight Supress Fine Tune */
...
/******************************************************************************/
         ...
         /* Reference Noise */
         {
            ...
            /* Noise Profile 6 */
            {
               ...
               {
                  0.000000f, 0.000000f, 0.000000f, 0.000000f, 7.551316f*2, 3.634627f*2, 1.958491f*2, 1.142016f*2,
                  0.000000f, 0.000000f, 0.000000f, 0.000000f, 2.807753f*4, 3.024365f*4, 2.225865f*4, 1.286158f*4,
                  0.000000f, 0.000000f, 0.000000f, 0.000000f, 2.544590f*6, 2.846839f*6, 2.000216f*6, 1.204090f*6
               },
               /* Denoise Scale Y */
               {
                  5.000000f, 5.000000f, 5.000000f, 5.000000f
...
/*********************************************************************/
   ...
   //{1.631000f, 1.000000f, 1.953000f},
   //{2.132000f, 1.000000f, 1.618000f},
   {2.210000f, 1.000000f, 1.710000f},
   /* D50 Whitebalance - RGB */
   //{1.984000f, 1.000000f, 1.721000f},
   {2.083000f, 1.000000f, 1.612900f},
   /* A Whitebalance - RGB */
   //{1.114800f, 1.000000f, 2.873000f},
   {1.320000f, 1.000000f, 2.500000f},
   ...
   //{2.124000f, 1.000000f, 1.63000f},
   {2.124000f, 1.000000f, 1.75000f},
},
/* Auto Whitebalance */
{
   1, /* Software Type */
...
/*********************************************************************/
   ...
   290,//318, /* Indoor Index */
   190,//218, /* Outdoor Index */
...
/*********************************************************************/
   ...
   /* AWB Reference Points w/HW */
   {
      ...
      /* Custom Daylight AWB Reference Point */
      {
         0.449000f,   /* R/G ratio */ //measure in OPPO HQ indoor
         0.618000f,   /* B/G ratio */ //measure in OPPO HQ indoor
      },
      /* Custom A AWB Reference Point */
      {
		 0.807000f,   /* R/G ratio */
...
/*********************************************************************/
   ...
   /* Exposure Table */
   {
      1, /* Use Digital Gain */
      /* Exposure Table */
      419,//422,//409,//422, /* Max Exposure Table Entries Before Digital Gain is Used for EV */
      0, /* Enable Digital Gain for EV Lowlight */
      436,//467,//409,//467, /* Max Exposure Table Entries for EV+2 with digital gain */
      {
		{	256	,	1	}, /*Gain=	1.0000	   Exposure Index =	0	 fps = 	96154.0	*/
		{	264	,	1	}, /*Gain=	1.0313	   Exposure Index =	1	 fps = 	96154.0	*/
		{	272	,	1	}, /*Gain=	1.0625	   Exposure Index =	2	 fps = 	96154.0	*/
		{	280	,	1	}, /*Gain=	1.0938	   Exposure Index =	3	 fps = 	96154.0	*/
		{	288	,	1	}, /*Gain=	1.1250	   Exposure Index =	4	 fps = 	96154.0	*/
		{	297	,	1	}, /*Gain=	1.1602	   Exposure Index =	5	 fps = 	96154.0	*/
		{	306	,	1	}, /*Gain=	1.1953	   Exposure Index =	6	 fps = 	96154.0	*/
		{	315	,	1	}, /*Gain=	1.2305	   Exposure Index =	7	 fps = 	96154.0	*/
		{	324	,	1	}, /*Gain=	1.2656	   Exposure Index =	8	 fps = 	96154.0	*/
		{	334	,	1	}, /*Gain=	1.3047	   Exposure Index =	9	 fps = 	96154.0	*/
		{	344	,	1	}, /*Gain=	1.3438	   Exposure Index =	10	 fps = 	96154.0	*/
		{	354	,	1	}, /*Gain=	1.3828	   Exposure Index =	11	 fps = 	96154.0	*/
		{	365	,	1	}, /*Gain=	1.4258	   Exposure Index =	12	 fps = 	96154.0	*/
		{	376	,	1	}, /*Gain=	1.4688	   Exposure Index =	13	 fps = 	96154.0	*/
		{	387	,	1	}, /*Gain=	1.5117	   Exposure Index =	14	 fps = 	96154.0	*/
		{	399	,	1	}, /*Gain=	1.5586	   Exposure Index =	15	 fps = 	96154.0	*/
		{	411	,	1	}, /*Gain=	1.6055	   Exposure Index =	16	 fps = 	96154.0	*/
		{	423	,	1	}, /*Gain=	1.6523	   Exposure Index =	17	 fps = 	96154.0	*/
		{	436	,	1	}, /*Gain=	1.7031	   Exposure Index =	18	 fps = 	96154.0	*/
		{	449	,	1	}, /*Gain=	1.7539	   Exposure Index =	19	 fps = 	96154.0	*/
		{	462	,	1	}, /*Gain=	1.8047	   Exposure Index =	20	 fps = 	96154.0	*/
		{	476	,	1	}, /*Gain=	1.8594	   Exposure Index =	21	 fps = 	96154.0	*/
		{	490	,	1	}, /*Gain=	1.9141	   Exposure Index =	22	 fps = 	96154.0	*/
		{	505	,	1	}, /*Gain=	1.9727	   Exposure Index =	23	 fps = 	96154.0	*/
		{	260	,	2	}, /*Gain=	1.0156	   Exposure Index =	24	 fps = 	48077.0	*/
		{	268	,	2	}, /*Gain=	1.0469	   Exposure Index =	25	 fps = 	48077.0	*/
		{	276	,	2	}, /*Gain=	1.0781	   Exposure Index =	26	 fps = 	48077.0	*/
		{	284	,	2	}, /*Gain=	1.1094	   Exposure Index =	27	 fps = 	48077.0	*/
		{	293	,	2	}, /*Gain=	1.1445	   Exposure Index =	28	 fps = 	48077.0	*/
		{	302	,	2	}, /*Gain=	1.1797	   Exposure Index =	29	 fps = 	48077.0	*/
		{	311	,	2	}, /*Gain=	1.2148	   Exposure Index =	30	 fps = 	48077.0	*/
		{	320	,	2	}, /*Gain=	1.2500	   Exposure Index =	31	 fps = 	48077.0	*/
		{	330	,	2	}, /*Gain=	1.2891	   Exposure Index =	32	 fps = 	48077.0	*/
		{	340	,	2	}, /*Gain=	1.3281	   Exposure Index =	33	 fps = 	48077.0	*/
		{	350	,	2	}, /*Gain=	1.3672	   Exposure Index =	34	 fps = 	48077.0	*/
		{	361	,	2	}, /*Gain=	1.4102	   Exposure Index =	35	 fps = 	48077.0	*/
		{	372	,	2	}, /*Gain=	1.4531	   Exposure Index =	36	 fps = 	48077.0	*/
		{	383	,	2	}, /*Gain=	1.4961	   Exposure Index =	37	 fps = 	48077.0	*/
		{	263	,	3	}, /*Gain=	1.0273	   Exposure Index =	38	 fps = 	32051.0	*/
		{	271	,	3	}, /*Gain=	1.0586	   Exposure Index =	39	 fps = 	32051.0	*/
		{	279	,	3	}, /*Gain=	1.0898	   Exposure Index =	40	 fps = 	32051.0	*/
		{	287	,	3	}, /*Gain=	1.1211	   Exposure Index =	41	 fps = 	32051.0	*/
		{	296	,	3	}, /*Gain=	1.1563	   Exposure Index =	42	 fps = 	32051.0	*/
		{	305	,	3	}, /*Gain=	1.1914	   Exposure Index =	43	 fps = 	32051.0	*/
		{	314	,	3	}, /*Gain=	1.2266	   Exposure Index =	44	 fps = 	32051.0	*/
		{	323	,	3	}, /*Gain=	1.2617	   Exposure Index =	45	 fps = 	32051.0	*/
		{	333	,	3	}, /*Gain=	1.3008	   Exposure Index =	46	 fps = 	32051.0	*/
		{	257	,	4	}, /*Gain=	1.0039	   Exposure Index =	47	 fps = 	24038.0	*/
		{	265	,	4	}, /*Gain=	1.0352	   Exposure Index =	48	 fps = 	24038.0	*/
		{	273	,	4	}, /*Gain=	1.0664	   Exposure Index =	49	 fps = 	24038.0	*/
		{	281	,	4	}, /*Gain=	1.0977	   Exposure Index =	50	 fps = 	24038.0	*/
		{	289	,	4	}, /*Gain=	1.1289	   Exposure Index =	51	 fps = 	24038.0	*/
		{	298	,	4	}, /*Gain=	1.1641	   Exposure Index =	52	 fps = 	24038.0	*/
		{	307	,	4	}, /*Gain=	1.1992	   Exposure Index =	53	 fps = 	24038.0	*/
		{	316	,	4	}, /*Gain=	1.2344	   Exposure Index =	54	 fps = 	24038.0	*/
		{	260	,	5	}, /*Gain=	1.0156	   Exposure Index =	55	 fps = 	19231.0	*/
		{	268	,	5	}, /*Gain=	1.0469	   Exposure Index =	56	 fps = 	19231.0	*/
		{	276	,	5	}, /*Gain=	1.0781	   Exposure Index =	57	 fps = 	19231.0	*/
		{	284	,	5	}, /*Gain=	1.1094	   Exposure Index =	58	 fps = 	19231.0	*/
		{	293	,	5	}, /*Gain=	1.1445	   Exposure Index =	59	 fps = 	19231.0	*/
		{	302	,	5	}, /*Gain=	1.1797	   Exposure Index =	60	 fps = 	19231.0	*/
		{	259	,	6	}, /*Gain=	1.0117	   Exposure Index =	61	 fps = 	16026.0	*/
		{	267	,	6	}, /*Gain=	1.0430	   Exposure Index =	62	 fps = 	16026.0	*/
		{	275	,	6	}, /*Gain=	1.0742	   Exposure Index =	63	 fps = 	16026.0	*/
		{	283	,	6	}, /*Gain=	1.1055	   Exposure Index =	64	 fps = 	16026.0	*/
		{	291	,	6	}, /*Gain=	1.1367	   Exposure Index =	65	 fps = 	16026.0	*/
		{	257	,	7	}, /*Gain=	1.0039	   Exposure Index =	66	 fps = 	13736.0	*/
		{	265	,	7	}, /*Gain=	1.0352	   Exposure Index =	67	 fps = 	13736.0	*/
		{	273	,	7	}, /*Gain=	1.0664	   Exposure Index =	68	 fps = 	13736.0	*/
		{	281	,	7	}, /*Gain=	1.0977	   Exposure Index =	69	 fps = 	13736.0	*/
		{	289	,	7	}, /*Gain=	1.1289	   Exposure Index =	70	 fps = 	13736.0	*/
		{	260	,	8	}, /*Gain=	1.0156	   Exposure Index =	71	 fps = 	12019.0	*/
		{	268	,	8	}, /*Gain=	1.0469	   Exposure Index =	72	 fps = 	12019.0	*/
		{	276	,	8	}, /*Gain=	1.0781	   Exposure Index =	73	 fps = 	12019.0	*/
		{	284	,	8	}, /*Gain=	1.1094	   Exposure Index =	74	 fps = 	12019.0	*/
		{	260	,	9	}, /*Gain=	1.0156	   Exposure Index =	75	 fps = 	10684.0	*/
		{	268	,	9	}, /*Gain=	1.0469	   Exposure Index =	76	 fps = 	10684.0	*/
		{	276	,	9	}, /*Gain=	1.0781	   Exposure Index =	77	 fps = 	10684.0	*/
		{	284	,	9	}, /*Gain=	1.1094	   Exposure Index =	78	 fps = 	10684.0	*/
		{	263	,	10	}, /*Gain=	1.0273	   Exposure Index =	79	 fps = 	9615.0	*/
		{	271	,	10	}, /*Gain=	1.0586	   Exposure Index =	80	 fps = 	9615.0	*/
		{	279	,	10	}, /*Gain=	1.0898	   Exposure Index =	81	 fps = 	9615.0	*/
		{	261	,	11	}, /*Gain=	1.0195	   Exposure Index =	82	 fps = 	8741.0	*/
		{	269	,	11	}, /*Gain=	1.0508	   Exposure Index =	83	 fps = 	8741.0	*/
		{	277	,	11	}, /*Gain=	1.0820	   Exposure Index =	84	 fps = 	8741.0	*/
		{	262	,	12	}, /*Gain=	1.0234	   Exposure Index =	85	 fps = 	8013.0	*/
		{	270	,	12	}, /*Gain=	1.0547	   Exposure Index =	86	 fps = 	8013.0	*/
		{	257	,	13	}, /*Gain=	1.0039	   Exposure Index =	87	 fps = 	7396.0	*/
		{	265	,	13	}, /*Gain=	1.0352	   Exposure Index =	88	 fps = 	7396.0	*/
		{	273	,	13	}, /*Gain=	1.0664	   Exposure Index =	89	 fps = 	7396.0	*/
		{	261	,	14	}, /*Gain=	1.0195	   Exposure Index =	90	 fps = 	6868.0	*/
		{	269	,	14	}, /*Gain=	1.0508	   Exposure Index =	91	 fps = 	6868.0	*/
		{	259	,	15	}, /*Gain=	1.0117	   Exposure Index =	92	 fps = 	6410.0	*/
		{	267	,	15	}, /*Gain=	1.0430	   Exposure Index =	93	 fps = 	6410.0	*/
		{	258	,	16	}, /*Gain=	1.0078	   Exposure Index =	94	 fps = 	6010.0	*/
		{	266	,	16	}, /*Gain=	1.0391	   Exposure Index =	95	 fps = 	6010.0	*/
		{	258	,	17	}, /*Gain=	1.0078	   Exposure Index =	96	 fps = 	5656.0	*/
		{	266	,	17	}, /*Gain=	1.0391	   Exposure Index =	97	 fps = 	5656.0	*/
		{	259	,	18	}, /*Gain=	1.0117	   Exposure Index =	98	 fps = 	5342.0	*/
		{	267	,	18	}, /*Gain=	1.0430	   Exposure Index =	99	 fps = 	5342.0	*/
		{	261	,	19	}, /*Gain=	1.0195	   Exposure Index =	100	 fps = 	5061.0	*/
		{	269	,	19	}, /*Gain=	1.0508	   Exposure Index =	101	 fps = 	5061.0	*/
		{	263	,	20	}, /*Gain=	1.0273	   Exposure Index =	102	 fps = 	4808.0	*/
		{	258	,	21	}, /*Gain=	1.0078	   Exposure Index =	103	 fps = 	4579.0	*/
		{	266	,	21	}, /*Gain=	1.0391	   Exposure Index =	104	 fps = 	4579.0	*/
		{	262	,	22	}, /*Gain=	1.0234	   Exposure Index =	105	 fps = 	4371.0	*/
		{	258	,	23	}, /*Gain=	1.0078	   Exposure Index =	106	 fps = 	4181.0	*/
		{	266	,	23	}, /*Gain=	1.0391	   Exposure Index =	107	 fps = 	4181.0	*/
		{	263	,	24	}, /*Gain=	1.0273	   Exposure Index =	108	 fps = 	4006.0	*/
		{	260	,	25	}, /*Gain=	1.0156	   Exposure Index =	109	 fps = 	3846.0	*/
		{	258	,	26	}, /*Gain=	1.0078	   Exposure Index =	110	 fps = 	3698.0	*/
		{	266	,	26	}, /*Gain=	1.0391	   Exposure Index =	111	 fps = 	3698.0	*/
		{	264	,	27	}, /*Gain=	1.0313	   Exposure Index =	112	 fps = 	3561.0	*/
		{	262	,	28	}, /*Gain=	1.0234	   Exposure Index =	113	 fps = 	3434.0	*/
		{	261	,	29	}, /*Gain=	1.0195	   Exposure Index =	114	 fps = 	3316.0	*/
		{	260	,	30	}, /*Gain=	1.0156	   Exposure Index =	115	 fps = 	3205.0	*/
		{	259	,	31	}, /*Gain=	1.0117	   Exposure Index =	116	 fps = 	3102.0	*/
		{	258	,	32	}, /*Gain=	1.0078	   Exposure Index =	117	 fps = 	3005.0	*/
		{	258	,	33	}, /*Gain=	1.0078	   Exposure Index =	118	 fps = 	2914.0	*/
		{	258	,	34	}, /*Gain=	1.0078	   Exposure Index =	119	 fps = 	2828.0	*/
		{	258	,	35	}, /*Gain=	1.0078	   Exposure Index =	120	 fps = 	2747.0	*/
		{	258	,	36	}, /*Gain=	1.0078	   Exposure Index =	121	 fps = 	2671.0	*/
		{	259	,	37	}, /*Gain=	1.0117	   Exposure Index =	122	 fps = 	2599.0	*/
		{	260	,	38	}, /*Gain=	1.0156	   Exposure Index =	123	 fps = 	2530.0	*/
		{	261	,	39	}, /*Gain=	1.0195	   Exposure Index =	124	 fps = 	2465.0	*/
		{	262	,	40	}, /*Gain=	1.0234	   Exposure Index =	125	 fps = 	2404.0	*/
		{	257	,	42	}, /*Gain=	1.0039	   Exposure Index =	126	 fps = 	2289.0	*/
		{	259	,	43	}, /*Gain=	1.0117	   Exposure Index =	127	 fps = 	2236.0	*/
		{	261	,	44	}, /*Gain=	1.0195	   Exposure Index =	128	 fps = 	2185.0	*/
		{	257	,	46	}, /*Gain=	1.0039	   Exposure Index =	129	 fps = 	2090.0	*/
		{	259	,	47	}, /*Gain=	1.0117	   Exposure Index =	130	 fps = 	2046.0	*/
		{	261	,	48	}, /*Gain=	1.0195	   Exposure Index =	131	 fps = 	2003.0	*/
		{	258	,	50	}, /*Gain=	1.0078	   Exposure Index =	132	 fps = 	1923.0	*/
		{	261	,	51	}, /*Gain=	1.0195	   Exposure Index =	133	 fps = 	1885.0	*/
		{	259	,	53	}, /*Gain=	1.0117	   Exposure Index =	134	 fps = 	1814.0	*/
		{	257	,	55	}, /*Gain=	1.0039	   Exposure Index =	135	 fps = 	1748.0	*/
		{	260	,	56	}, /*Gain=	1.0156	   Exposure Index =	136	 fps = 	1717.0	*/
		{	259	,	58	}, /*Gain=	1.0117	   Exposure Index =	137	 fps = 	1658.0	*/
		{	258	,	60	}, /*Gain=	1.0078	   Exposure Index =	138	 fps = 	1603.0	*/
		{	257	,	62	}, /*Gain=	1.0039	   Exposure Index =	139	 fps = 	1551.0	*/
		{	256	,	64	}, /*Gain=	1.0000	   Exposure Index =	140	 fps = 	1502.0	*/
		{	260	,	65	}, /*Gain=	1.0156	   Exposure Index =	141	 fps = 	1479.0	*/
		{	260	,	67	}, /*Gain=	1.0156	   Exposure Index =	142	 fps = 	1435.0	*/
		{	256	,	70	}, /*Gain=	1.0000	   Exposure Index =	143	 fps = 	1374.0	*/
		{	256	,	72	}, /*Gain=	1.0000	   Exposure Index =	144	 fps = 	1335.0	*/
		{	257	,	74	}, /*Gain=	1.0039	   Exposure Index =	145	 fps = 	1299.0	*/
		{	258	,	76	}, /*Gain=	1.0078	   Exposure Index =	146	 fps = 	1265.0	*/
		{	259	,	78	}, /*Gain=	1.0117	   Exposure Index =	147	 fps = 	1233.0	*/
		{	257	,	81	}, /*Gain=	1.0039	   Exposure Index =	148	 fps = 	1187.0	*/
		{	258	,	83	}, /*Gain=	1.0078	   Exposure Index =	149	 fps = 	1158.0	*/
		{	256	,	86	}, /*Gain=	1.0000	   Exposure Index =	150	 fps = 	1118.0	*/
		{	258	,	88	}, /*Gain=	1.0078	   Exposure Index =	151	 fps = 	1093.0	*/
		{	257	,	91	}, /*Gain=	1.0039	   Exposure Index =	152	 fps = 	1057.0	*/
		{	256	,	94	}, /*Gain=	1.0000	   Exposure Index =	153	 fps = 	1023.0	*/
		{	258	,	96	}, /*Gain=	1.0078	   Exposure Index =	154	 fps = 	1002.0	*/
		{	258	,	99	}, /*Gain=	1.0078	   Exposure Index =	155	 fps = 	971.0	*/
		{	258	,	102	}, /*Gain=	1.0078	   Exposure Index =	156	 fps = 	943.0	*/
		{	258	,	105	}, /*Gain=	1.0078	   Exposure Index =	157	 fps = 	916.0	*/
		{	258	,	108	}, /*Gain=	1.0078	   Exposure Index =	158	 fps = 	890.0	*/
		{	256	,	112	}, /*Gain=	1.0000	   Exposure Index =	159	 fps = 	859.0	*/
		{	257	,	115	}, /*Gain=	1.0039	   Exposure Index =	160	 fps = 	836.0	*/
		{	258	,	118	}, /*Gain=	1.0078	   Exposure Index =	161	 fps = 	815.0	*/
		{	257	,	122	}, /*Gain=	1.0039	   Exposure Index =	162	 fps = 	788.0	*/
		{	256	,	126	}, /*Gain=	1.0000	   Exposure Index =	163	 fps = 	763.0	*/
		{	258	,	129	}, /*Gain=	1.0078	   Exposure Index =	164	 fps = 	745.0	*/
		{	258	,	133	}, /*Gain=	1.0078	   Exposure Index =	165	 fps = 	723.0	*/
		{	256	,	138	}, /*Gain=	1.0000	   Exposure Index =	166	 fps = 	697.0	*/
		{	256	,	142	}, /*Gain=	1.0000	   Exposure Index =	167	 fps = 	677.0	*/
		{	256	,	146	}, /*Gain=	1.0000	   Exposure Index =	168	 fps = 	659.0	*/
		{	257	,	150	}, /*Gain=	1.0039	   Exposure Index =	169	 fps = 	641.0	*/
		{	256	,	155	}, /*Gain=	1.0000	   Exposure Index =	170	 fps = 	620.0	*/
		{	257	,	159	}, /*Gain=	1.0039	   Exposure Index =	171	 fps = 	605.0	*/
		{	257	,	164	}, /*Gain=	1.0039	   Exposure Index =	172	 fps = 	586.0	*/
		{	257	,	169	}, /*Gain=	1.0039	   Exposure Index =	173	 fps = 	569.0	*/
		{	257	,	174	}, /*Gain=	1.0039	   Exposure Index =	174	 fps = 	553.0	*/
		{	257	,	179	}, /*Gain=	1.0039	   Exposure Index =	175	 fps = 	537.0	*/
		{	256	,	185	}, /*Gain=	1.0000	   Exposure Index =	176	 fps = 	520.0	*/
		{	257	,	190	}, /*Gain=	1.0039	   Exposure Index =	177	 fps = 	506.0	*/
		{	257	,	196	}, /*Gain=	1.0039	   Exposure Index =	178	 fps = 	491.0	*/
		{	257	,	202	}, /*Gain=	1.0039	   Exposure Index =	179	 fps = 	476.0	*/
		{	257	,	208	}, /*Gain=	1.0039	   Exposure Index =	180	 fps = 	462.0	*/
		{	256	,	215	}, /*Gain=	1.0000	   Exposure Index =	181	 fps = 	447.0	*/
		{	257	,	221	}, /*Gain=	1.0039	   Exposure Index =	182	 fps = 	435.0	*/
		{	257	,	228	}, /*Gain=	1.0039	   Exposure Index =	183	 fps = 	422.0	*/
		{	257	,	235	}, /*Gain=	1.0039	   Exposure Index =	184	 fps = 	409.0	*/
		{	257	,	242	}, /*Gain=	1.0039	   Exposure Index =	185	 fps = 	397.0	*/
		{	256	,	250	}, /*Gain=	1.0000	   Exposure Index =	186	 fps = 	385.0	*/
		{	256	,	257	}, /*Gain=	1.0000	   Exposure Index =	187	 fps = 	374.0	*/
		{	257	,	264	}, /*Gain=	1.0039	   Exposure Index =	188	 fps = 	364.0	*/
		{	257	,	272	}, /*Gain=	1.0039	   Exposure Index =	189	 fps = 	354.0	*/
		{	256	,	281	}, /*Gain=	1.0000	   Exposure Index =	190	 fps = 	342.0	*/
		{	256	,	289	}, /*Gain=	1.0000	   Exposure Index =	191	 fps = 	333.0	*/
		{	257	,	297	}, /*Gain=	1.0039	   Exposure Index =	192	 fps = 	324.0	*/
		{	256	,	307	}, /*Gain=	1.0000	   Exposure Index =	193	 fps = 	313.0	*/
		{	256	,	316	}, /*Gain=	1.0000	   Exposure Index =	194	 fps = 	304.0	*/
		{	256	,	325	}, /*Gain=	1.0000	   Exposure Index =	195	 fps = 	296.0	*/
		{	257	,	334	}, /*Gain=	1.0039	   Exposure Index =	196	 fps = 	288.0	*/
		{	256	,	345	}, /*Gain=	1.0000	   Exposure Index =	197	 fps = 	279.0	*/
		{	256	,	355	}, /*Gain=	1.0000	   Exposure Index =	198	 fps = 	271.0	*/
		{	256	,	365	}, /*Gain=	1.0000	   Exposure Index =	199	 fps = 	263.0	*/
		{	257	,	375	}, /*Gain=	1.0039	   Exposure Index =	200	 fps = 	256.0	*/
		{	257	,	387	}, /*Gain=	1.0039	   Exposure Index =	201	 fps = 	248.0	*/
		{	256	,	400	}, /*Gain=	1.0000	   Exposure Index =	202	 fps = 	240.0	*/
		{	256	,	412	}, /*Gain=	1.0000	   Exposure Index =	203	 fps = 	233.0	*/
		{	256	,	424	}, /*Gain=	1.0000	   Exposure Index =	204	 fps = 	227.0	*/
		{	256	,	436	}, /*Gain=	1.0000	   Exposure Index =	205	 fps = 	221.0	*/
		{	256	,	449	}, /*Gain=	1.0000	   Exposure Index =	206	 fps = 	214.0	*/
		{	256	,	462	}, /*Gain=	1.0000	   Exposure Index =	207	 fps = 	208.0	*/
		{	256	,	475	}, /*Gain=	1.0000	   Exposure Index =	208	 fps = 	202.0	*/
		{	256	,	489	}, /*Gain=	1.0000	   Exposure Index =	209	 fps = 	197.0	*/
		{	256	,	503	}, /*Gain=	1.0000	   Exposure Index =	210	 fps = 	191.0	*/
		{	256	,	518	}, /*Gain=	1.0000	   Exposure Index =	211	 fps = 	186.0	*/
		{	256	,	533	}, /*Gain=	1.0000	   Exposure Index =	212	 fps = 	180.0	*/
		{	256	,	548	}, /*Gain=	1.0000	   Exposure Index =	213	 fps = 	175.0	*/
		{	256	,	564	}, /*Gain=	1.0000	   Exposure Index =	214	 fps = 	170.0	*/
		{	256	,	580	}, /*Gain=	1.0000	   Exposure Index =	215	 fps = 	166.0	*/
		{	256	,	597	}, /*Gain=	1.0000	   Exposure Index =	216	 fps = 	161.0	*/
		{	256	,	614	}, /*Gain=	1.0000	   Exposure Index =	217	 fps = 	157.0	*/
		{	256	,	632	}, /*Gain=	1.0000	   Exposure Index =	218	 fps = 	152.0	*/
		{	256	,	650	}, /*Gain=	1.0000	   Exposure Index =	219	 fps = 	148.0	*/
		{	256	,	669	}, /*Gain=	1.0000	   Exposure Index =	220	 fps = 	144.0	*/
		{	256	,	689	}, /*Gain=	1.0000	   Exposure Index =	221	 fps = 	140.0	*/
		{	256	,	709	}, /*Gain=	1.0000	   Exposure Index =	222	 fps = 	136.0	*/
		{	256	,	730	}, /*Gain=	1.0000	   Exposure Index =	223	 fps = 	132.0	*/
		{	256	,	751	}, /*Gain=	1.0000	   Exposure Index =	224	 fps = 	128.0	*/
		{	256	,	773	}, /*Gain=	1.0000	   Exposure Index =	225	 fps = 	124.0	*/
		{	256	,	796	}, /*Gain=	1.0000	   Exposure Index =	226	 fps = 	121.0	*/
		{	256	,	819	}, /*Gain=	1.0000	   Exposure Index =	227	 fps = 	117.0	*/
		{	256	,	843	}, /*Gain=	1.0000	   Exposure Index =	228	 fps = 	114.0	*/
		{	256	,	868	}, /*Gain=	1.0000	   Exposure Index =	229	 fps = 	111.0	*/
		{	256	,	894	}, /*Gain=	1.0000	   Exposure Index =	230	 fps = 	108.0	*/
		{	256	,	920	}, /*Gain=	1.0000	   Exposure Index =	231	 fps = 	105.0	*/
		{	256	,	947	}, /*Gain=	1.0000	   Exposure Index =	232	 fps = 	102.0	*/
		{	256	,	975	}, /*Gain=	1.0000	   Exposure Index =	233	 fps = 	99.0	*/
		{	256	,	1004	}, /*Gain=	1.0000	   Exposure Index =	234	 fps = 	96.0	*/
		{	256	,	1034	}, /*Gain=	1.0000	   Exposure Index =	235	 fps = 	93.0	*/
		{	256	,	1065	}, /*Gain=	1.0000	   Exposure Index =	236	 fps = 	90.0	*/
		{	256	,	1096	}, /*Gain=	1.0000	   Exposure Index =	237	 fps = 	88.0	*/
		{	256	,	1128	}, /*Gain=	1.0000	   Exposure Index =	238	 fps = 	85.0	*/
		{	256	,	1161	}, /*Gain=	1.0000	   Exposure Index =	239	 fps = 	83.0	*/
		{	256	,	1195	}, /*Gain=	1.0000	   Exposure Index =	240	 fps = 	80.0	*/
		{	256	,	1230	}, /*Gain=	1.0000	   Exposure Index =	241	 fps = 	78.0	*/
		{	256	,	1266	}, /*Gain=	1.0000	   Exposure Index =	242	 fps = 	76.0	*/
		{	256	,	1303	}, /*Gain=	1.0000	   Exposure Index =	243	 fps = 	74.0	*/
		{	256	,	1342	}, /*Gain=	1.0000	   Exposure Index =	244	 fps = 	72.0	*/
		{	256	,	1382	}, /*Gain=	1.0000	   Exposure Index =	245	 fps = 	70.0	*/
		{	256	,	1423	}, /*Gain=	1.0000	   Exposure Index =	246	 fps = 	68.0	*/
		{	256	,	1465	}, /*Gain=	1.0000	   Exposure Index =	247	 fps = 	66.0	*/
		{	256	,	1508	}, /*Gain=	1.0000	   Exposure Index =	248	 fps = 	64.0	*/
		{	256	,	1553	}, /*Gain=	1.0000	   Exposure Index =	249	 fps = 	62.0	*/
		{	256	,	1599	}, /*Gain=	1.0000	   Exposure Index =	250	 fps = 	60.0	*/
		{	264	,	1599	}, /*Gain=	1.0300	   Exposure Index =	251	 fps = 	60.0	*/
		{	272	,	1599	}, /*Gain=	1.0609	   Exposure Index =	252	 fps = 	60.0	*/
		{	280	,	1599	}, /*Gain=	1.0927	   Exposure Index =	253	 fps = 	60.0	*/
		{	288	,	1599	}, /*Gain=	1.1255	   Exposure Index =	254	 fps = 	60.0	*/
		{	297	,	1599	}, /*Gain=	1.1593	   Exposure Index =	255	 fps = 	60.0	*/
		{	306	,	1599	}, /*Gain=	1.1941	   Exposure Index =	256	 fps = 	60.0	*/
		{	315	,	1599	}, /*Gain=	1.2299	   Exposure Index =	257	 fps = 	60.0	*/
		{	324	,	1599	}, /*Gain=	1.2668	   Exposure Index =	258	 fps = 	60.0	*/
		{	334	,	1599	}, /*Gain=	1.3048	   Exposure Index =	259	 fps = 	60.0	*/
		{	344	,	1599	}, /*Gain=	1.3439	   Exposure Index =	260	 fps = 	60.0	*/
		{	354	,	1599	}, /*Gain=	1.3842	   Exposure Index =	261	 fps = 	60.0	*/
		{	365	,	1599	}, /*Gain=	1.4258	   Exposure Index =	262	 fps = 	60.0	*/
		{	376	,	1599	}, /*Gain=	1.4685	   Exposure Index =	263	 fps = 	60.0	*/
		{	387	,	1599	}, /*Gain=	1.5126	   Exposure Index =	264	 fps = 	60.0	*/
		{	399	,	1599	}, /*Gain=	1.5580	   Exposure Index =	265	 fps = 	60.0	*/
		{	411	,	1599	}, /*Gain=	1.6047	   Exposure Index =	266	 fps = 	60.0	*/
		{	423	,	1599	}, /*Gain=	1.6528	   Exposure Index =	267	 fps = 	60.0	*/
		{	436	,	1599	}, /*Gain=	1.7024	   Exposure Index =	268	 fps = 	60.0	*/
		{	449	,	1599	}, /*Gain=	1.7535	   Exposure Index =	269	 fps = 	60.0	*/
		{	462	,	1599	}, /*Gain=	1.8061	   Exposure Index =	270	 fps = 	60.0	*/
		{	476	,	1599	}, /*Gain=	1.8603	   Exposure Index =	271	 fps = 	60.0	*/
		{	491	,	1599	}, /*Gain=	1.9161	   Exposure Index =	272	 fps = 	60.0	*/
		{	505	,	1599	}, /*Gain=	1.9736	   Exposure Index =	273	 fps = 	60.0	*/
		{	520	,	1599	}, /*Gain=	2.0328	   Exposure Index =	274	 fps = 	60.0	*/
		{	536	,	1599	}, /*Gain=	2.0938	   Exposure Index =	275	 fps = 	60.0	*/
		{	552	,	1599	}, /*Gain=	2.1566	   Exposure Index =	276	 fps = 	60.0	*/
		{	569	,	1599	}, /*Gain=	2.2213	   Exposure Index =	277	 fps = 	60.0	*/
		{	586	,	1599	}, /*Gain=	2.2879	   Exposure Index =	278	 fps = 	60.0	*/
		{	603	,	1599	}, /*Gain=	2.3566	   Exposure Index =	279	 fps = 	60.0	*/
		{	621	,	1599	}, /*Gain=	2.4273	   Exposure Index =	280	 fps = 	60.0	*/
		{	640	,	1599	}, /*Gain=	2.5001	   Exposure Index =	281	 fps = 	60.0	*/
		{	659	,	1599	}, /*Gain=	2.5751	   Exposure Index =	282	 fps = 	60.0	*/
		{	679	,	1599	}, /*Gain=	2.6523	   Exposure Index =	283	 fps = 	60.0	*/
		{	699	,	1599	}, /*Gain=	2.7319	   Exposure Index =	284	 fps = 	60.0	*/
		{	720	,	1599	}, /*Gain=	2.8139	   Exposure Index =	285	 fps = 	60.0	*/
		{	742	,	1599	}, /*Gain=	2.8983	   Exposure Index =	286	 fps = 	60.0	*/
		{	764	,	1599	}, /*Gain=	2.9852	   Exposure Index =	287	 fps = 	60.0	*/
		{	787	,	1599	}, /*Gain=	3.0748	   Exposure Index =	288	 fps = 	60.0	*/
		{	811	,	1599	}, /*Gain=	3.1670	   Exposure Index =	289	 fps = 	60.0	*/
		{	835	,	1599	}, /*Gain=	3.2620	   Exposure Index =	290	 fps = 	60.0	*/
		{	860	,	1599	}, /*Gain=	3.3599	   Exposure Index =	291	 fps = 	60.0	*/
		{	886	,	1599	}, /*Gain=	3.4607	   Exposure Index =	292	 fps = 	60.0	*/
		{	913	,	1599	}, /*Gain=	3.5645	   Exposure Index =	293	 fps = 	60.0	*/
		{	940	,	1599	}, /*Gain=	3.6715	   Exposure Index =	294	 fps = 	60.0	*/
		{	968	,	1599	}, /*Gain=	3.7816	   Exposure Index =	295	 fps = 	60.0	*/
		{	997	,	1599	}, /*Gain=	3.8950	   Exposure Index =	296	 fps = 	60.0	*/
		{	997	,	1647	}, /*Gain=	3.8950	   Exposure Index =	297	 fps = 	58.0	*/
		{	997	,	1696	}, /*Gain=	3.8950	   Exposure Index =	298	 fps = 	57.0	*/
		{	997	,	1747	}, /*Gain=	3.8950	   Exposure Index =	299	 fps = 	55.0	*/
		{	997	,	1800	}, /*Gain=	3.8950	   Exposure Index =	300	 fps = 	53.0	*/
		{	997	,	1854	}, /*Gain=	3.8950	   Exposure Index =	301	 fps = 	52.0	*/
		{	997	,	1909	}, /*Gain=	3.8950	   Exposure Index =	302	 fps = 	50.0	*/
		{	997	,	1967	}, /*Gain=	3.8950	   Exposure Index =	303	 fps = 	49.0	*/
		{	997	,	2026	}, /*Gain=	3.8950	   Exposure Index =	304	 fps = 	47.0	*/
		{	997	,	2086	}, /*Gain=	3.8950	   Exposure Index =	305	 fps = 	46.0	*/
		{	997	,	2149	}, /*Gain=	3.8950	   Exposure Index =	306	 fps = 	45.0	*/
		{	997	,	2213	}, /*Gain=	3.8950	   Exposure Index =	307	 fps = 	43.0	*/
		{	997	,	2280	}, /*Gain=	3.8950	   Exposure Index =	308	 fps = 	42.0	*/
		{	997	,	2348	}, /*Gain=	3.8950	   Exposure Index =	309	 fps = 	41.0	*/
		{	997	,	2419	}, /*Gain=	3.8950	   Exposure Index =	310	 fps = 	40.0	*/
		{	997	,	2491	}, /*Gain=	3.8950	   Exposure Index =	311	 fps = 	39.0	*/
		{	997	,	2566	}, /*Gain=	3.8950	   Exposure Index =	312	 fps = 	37.0	*/
		{	997	,	2643	}, /*Gain=	3.8950	   Exposure Index =	313	 fps = 	36.0	*/
		{	997	,	2722	}, /*Gain=	3.8950	   Exposure Index =	314	 fps = 	35.0	*/
		{	997	,	2804	}, /*Gain=	3.8950	   Exposure Index =	315	 fps = 	34.0	*/
		{	997	,	2888	}, /*Gain=	3.8950	   Exposure Index =	316	 fps = 	33.0	*/
		{	997	,	2975	}, /*Gain=	3.8950	   Exposure Index =	317	 fps = 	32.0	*/
		{	997	,	3064	}, /*Gain=	3.8950	   Exposure Index =	318	 fps = 	31.0	*/
		{	997	,	3156	}, /*Gain=	3.8950	   Exposure Index =	319	 fps = 	30.0	*/
		{	1027	,	3156	}, /*Gain=	4.0119	   Exposure Index =	320	 fps = 	30.0	*/
		{	1058	,	3156	}, /*Gain=	4.1323	   Exposure Index =	321	 fps = 	30.0	*/
		{	1090	,	3156	}, /*Gain=	4.2562	   Exposure Index =	322	 fps = 	30.0	*/
		{	1122	,	3156	}, /*Gain=	4.3839	   Exposure Index =	323	 fps = 	30.0	*/
		{	1156	,	3156	}, /*Gain=	4.5154	   Exposure Index =	324	 fps = 	30.0	*/
		{	1191	,	3156	}, /*Gain=	4.6509	   Exposure Index =	325	 fps = 	30.0	*/
		{	1226	,	3156	}, /*Gain=	4.7904	   Exposure Index =	326	 fps = 	30.0	*/
		{	1263	,	3156	}, /*Gain=	4.9341	   Exposure Index =	327	 fps = 	30.0	*/
		{	1301	,	3156	}, /*Gain=	5.0821	   Exposure Index =	328	 fps = 	30.0	*/
		{	1340	,	3156	}, /*Gain=	5.2346	   Exposure Index =	329	 fps = 	30.0	*/
		{	1380	,	3156	}, /*Gain=	5.3917	   Exposure Index =	330	 fps = 	30.0	*/
		{	1422	,	3156	}, /*Gain=	5.5534	   Exposure Index =	331	 fps = 	30.0	*/
		{	1464	,	3156	}, /*Gain=	5.7200	   Exposure Index =	332	 fps = 	30.0	*/
		{	1508	,	3156	}, /*Gain=	5.8916	   Exposure Index =	333	 fps = 	30.0	*/
		{	1553	,	3156	}, /*Gain=	6.0684	   Exposure Index =	334	 fps = 	30.0	*/
		{	1600	,	3156	}, /*Gain=	6.2504	   Exposure Index =	335	 fps = 	30.0	*/
		{	1648	,	3156	}, /*Gain=	6.4379	   Exposure Index =	336	 fps = 	30.0	*/
		{	1698	,	3156	}, /*Gain=	6.6311	   Exposure Index =	337	 fps = 	30.0	*/
		{	1748	,	3156	}, /*Gain=	6.8300	   Exposure Index =	338	 fps = 	30.0	*/
		{	1801	,	3156	}, /*Gain=	7.0349	   Exposure Index =	339	 fps = 	30.0	*/
		{	1855	,	3156	}, /*Gain=	7.2459	   Exposure Index =	340	 fps = 	30.0	*/
		{	1911	,	3156	}, /*Gain=	7.4633	   Exposure Index =	341	 fps = 	30.0	*/
		{	1968	,	3156	}, /*Gain=	7.6872	   Exposure Index =	342	 fps = 	30.0	*/
		{	2027	,	3156	}, /*Gain=	7.9178	   Exposure Index =	343	 fps = 	30.0	*/
		{	2088	,	3156	}, /*Gain=	8.1554	   Exposure Index =	344	 fps = 	30.0	*/
		{	2088	,	3250	}, /*Gain=	8.1554	   Exposure Index =	345	 fps = 	30.0	*/
		{	2088	,	3348	}, /*Gain=	8.1554	   Exposure Index =	346	 fps = 	29.0	*/
		{	2088	,	3448	}, /*Gain=	8.1554	   Exposure Index =	347	 fps = 	28.0	*/
		{	2088	,	3552	}, /*Gain=	8.1554	   Exposure Index =	348	 fps = 	27.0	*/
		{	2088	,	3658	}, /*Gain=	8.1554	   Exposure Index =	349	 fps = 	26.0	*/
		{	2088	,	3768	}, /*Gain=	8.1554	   Exposure Index =	350	 fps = 	26.0	*/
		{	2088	,	3881	}, /*Gain=	8.1554	   Exposure Index =	351	 fps = 	25.0	*/
		{	2088	,	3998	}, /*Gain=	8.1554	   Exposure Index =	352	 fps = 	24.0	*/
		{	2088	,	4118	}, /*Gain=	8.1554	   Exposure Index =	353	 fps = 	23.0	*/
		{	2088	,	4241	}, /*Gain=	8.1554	   Exposure Index =	354	 fps = 	23.0	*/
		{	2088	,	4368	}, /*Gain=	8.1554	   Exposure Index =	355	 fps = 	22.0	*/
		{	2088	,	4499	}, /*Gain=	8.1554	   Exposure Index =	356	 fps = 	21.0	*/
		{	2088	,	4634	}, /*Gain=	8.1554	   Exposure Index =	357	 fps = 	21.0	*/
		{	2088	,	4773	}, /*Gain=	8.1554	   Exposure Index =	358	 fps = 	20.0	*/
		{	2088	,	4917	}, /*Gain=	8.1554	   Exposure Index =	359	 fps = 	20.0	*/
		{	2088	,	5064	}, /*Gain=	8.1554	   Exposure Index =	360	 fps = 	19.0	*/
		{	2088	,	5216	}, /*Gain=	8.1554	   Exposure Index =	361	 fps = 	18.0	*/
		{	2088	,	5372	}, /*Gain=	8.1554	   Exposure Index =	362	 fps = 	18.0	*/
		{	2088	,	5534	}, /*Gain=	8.1554	   Exposure Index =	363	 fps = 	17.0	*/
		{	2088	,	5700	}, /*Gain=	8.1554	   Exposure Index =	364	 fps = 	17.0	*/
		{	2088	,	5871	}, /*Gain=	8.1554	   Exposure Index =	365	 fps = 	16.0	*/
		{	2088	,	6047	}, /*Gain=	8.1554	   Exposure Index =	366	 fps = 	16.0	*/
		{	2088	,	6228	}, /*Gain=	8.1554	   Exposure Index =	367	 fps = 	15.0	*/
		{	2100	,	6378	}, /*Gain=	8.2043	   Exposure Index =	368	 fps = 	15.0	*/
		{	2163	,	6378	}, /*Gain=	8.4504	   Exposure Index =	369	 fps = 	15.0	*/
		{	2228	,	6378	}, /*Gain=	8.7039	   Exposure Index =	370	 fps = 	15.0	*/
		{	2295	,	6378	}, /*Gain=	8.9650	   Exposure Index =	371	 fps = 	15.0	*/
		{	2364	,	6378	}, /*Gain=	9.2340	   Exposure Index =	372	 fps = 	15.0	*/
		{	2435	,	6378	}, /*Gain=	9.5110	   Exposure Index =	373	 fps = 	15.0	*/
		{	2508	,	6378	}, /*Gain=	9.7963	   Exposure Index =	374	 fps = 	15.0	*/
		{	2583	,	6378	}, /*Gain=	10.0902	   Exposure Index =	375	 fps = 	15.0	*/
		{	2661	,	6378	}, /*Gain=	10.3929	   Exposure Index =	376	 fps = 	15.0	*/
		{	2740	,	6378	}, /*Gain=	10.7047	   Exposure Index =	377	 fps = 	15.0	*/
		{	2823	,	6378	}, /*Gain=	11.0259	   Exposure Index =	378	 fps = 	15.0	*/
		{	2907	,	6378	}, /*Gain=	11.3567	   Exposure Index =	379	 fps = 	15.0	*/
		{	2995	,	6378	}, /*Gain=	11.6974	   Exposure Index =	380	 fps = 	15.0	*/
		{	3084	,	6378	}, /*Gain=	12.0483	   Exposure Index =	381	 fps = 	15.0	*/
		{	3177	,	6378	}, /*Gain=	12.4097	   Exposure Index =	382	 fps = 	15.0	*/
		{	3272	,	6378	}, /*Gain=	12.7820	   Exposure Index =	383	 fps = 	15.0	*/
		{	3370	,	6378	}, /*Gain=	13.1655	   Exposure Index =	384	 fps = 	15.0	*/
		{	3471	,	6378	}, /*Gain=	13.5604	   Exposure Index =	385	 fps = 	15.0	*/
		{	3576	,	6378	}, /*Gain=	13.9673	   Exposure Index =	386	 fps = 	15.0	*/
		{	3683	,	6378	}, /*Gain=	14.3863	   Exposure Index =	387	 fps = 	15.0	*/
		{	3793	,	6378	}, /*Gain=	14.8179	   Exposure Index =	388	 fps = 	15.0	*/
		{	3907	,	6378	}, /*Gain=	15.2624	   Exposure Index =	389	 fps = 	15.0	*/
		{	4024	,	6378	}, /*Gain=	15.7203	   Exposure Index =	390	 fps = 	15.0	*/
		{	4145	,	6378	}, /*Gain=	16.1919	   Exposure Index =	391	 fps = 	15.0	*/
		{	4269	,	6378	}, /*Gain=	16.6776	   Exposure Index =	392	 fps = 	15.0	*/
		{	4398	,	6378	}, /*Gain=	17.1780	   Exposure Index =	393	 fps = 	15.0	*/
		{	4529	,	6378	}, /*Gain=	17.6933	   Exposure Index =	394	 fps = 	15.0	*/
		{	4665	,	6378	}, /*Gain=	18.2241	   Exposure Index =	395	 fps = 	15.0	*/
		{	4805	,	6378	}, /*Gain=	18.7708	   Exposure Index =	396	 fps = 	15.0	*/
		{	4949	,	6378	}, /*Gain=	19.3339	   Exposure Index =	397	 fps = 	15.0	*/
		{	5098	,	6378	}, /*Gain=	19.9140	   Exposure Index =	398	 fps = 	15.0	*/
		{	5251	,	6378	}, /*Gain=	20.5114	   Exposure Index =	399	 fps = 	15.0	*/
		{	5408	,	6378	}, /*Gain=	21.1267	   Exposure Index =	400	 fps = 	15.0	*/
		{	5571	,	6378	}, /*Gain=	21.7605	   Exposure Index =	401	 fps = 	15.0	*/
		{	5738	,	6378	}, /*Gain=	22.4133	   Exposure Index =	402	 fps = 	15.0	*/
		{	5910	,	6378	}, /*Gain=	23.0857	   Exposure Index =	403	 fps = 	15.0	*/
		{	6087	,	6378	}, /*Gain=	23.7783	   Exposure Index =	404	 fps = 	15.0	*/
		{	6270	,	6378	}, /*Gain=	24.4917	   Exposure Index =	405	 fps = 	15.0	*/
		{	6458	,	6378	}, /*Gain=	25.2264	   Exposure Index =	406	 fps = 	15.0	*/
		{	6652	,	6378	}, /*Gain=	25.9832	   Exposure Index =	407	 fps = 	15.0	*/
		{	6851	,	6378	}, /*Gain=	26.7627	   Exposure Index =	408	 fps = 	15.0	*/
		{	7057	,	6378	}, /*Gain=	27.5656	   Exposure Index =	409	 fps = 	15.0	*/
		{	7268	,	6378	}, /*Gain=	28.3925	   Exposure Index =	410	 fps = 	15.0	*/
		{	7487	,	6378	}, /*Gain=	29.2443	   Exposure Index =	411	 fps = 	15.0	*/
		{	7711	,	6378	}, /*Gain=	30.1217	   Exposure Index =	412	 fps = 	15.0	*/
		{	7942	,	6378	}, /*Gain=	31.0253	   Exposure Index =	413	 fps = 	15.0	*/
		{	8181	,	6378	}, /*Gain=	31.9561	   Exposure Index =	414	 fps = 	15.0	*/
		{	8426	,	6378	}, /*Gain=	32.9147	   Exposure Index =	415	 fps = 	15.0	*/
		{	8679	,	6378	}, /*Gain=	33.9022	   Exposure Index =	416	 fps = 	15.0	*/
		{	8939	,	6378	}, /*Gain=	34.9193	   Exposure Index =	417	 fps = 	15.0	*/
		{	9208	,	6378	}, /*Gain=	35.9668	   Exposure Index =	418	 fps = 	15.0	*/
		{	9484	,	6378	}, /*Gain=	37.0458	   Exposure Index =	419	 fps = 	15.0	*/
		{	9768	,	6378	}, /*Gain=	38.1572	   Exposure Index =	420	 fps = 	15.0	*/
		{	10061	,	6378	}, /*Gain=	39.3019	   Exposure Index =	421	 fps = 	15.0	*/
		{	10363	,	6378	}, /*Gain=	40.4810	   Exposure Index =	422	 fps = 	15.0	*/
		{	10674	,	6378	}, /*Gain=	41.6954	   Exposure Index =	423	 fps = 	15.0	*/
		{	10994	,	6378	}, /*Gain=	42.9463	   Exposure Index =	424	 fps = 	15.0	*/
		{	11324	,	6378	}, /*Gain=	44.2347	   Exposure Index =	425	 fps = 	15.0	*/
		{	11664	,	6378	}, /*Gain=	45.5617	   Exposure Index =	426	 fps = 	15.0	*/
		{	12014	,	6378	}, /*Gain=	46.9286	   Exposure Index =	427	 fps = 	15.0	*/
		{	12374	,	6378	}, /*Gain=	48.3364	   Exposure Index =	428	 fps = 	15.0	*/
		{	12745	,	6378	}, /*Gain=	49.7865	   Exposure Index =	429	 fps = 	15.0	*/
		{	13128	,	6378	}, /*Gain=	51.2801	   Exposure Index =	430	 fps = 	15.0	*/
		{	13522	,	6378	} /*Gain=	52.8185	   Exposure Index =	431	 fps = 	15.0	*/
      },
   },
...
/*********************************************************************/
   ...
   45,//50,//47, /* Outdoor Luma Target */ ==> set to 40 for LA test in outdoor
...
/******************************************************************************/
   ...
   20.000000f, /* AEC LED Snapshot Flux Hi */
...
/*******************************************************************************/
      ...
      1.60000f, /* Color Luma Decrease Ratio */
