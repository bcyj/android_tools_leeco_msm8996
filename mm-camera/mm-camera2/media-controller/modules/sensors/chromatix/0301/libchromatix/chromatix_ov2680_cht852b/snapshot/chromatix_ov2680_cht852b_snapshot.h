...
/******************************************************************************/
      ...
      /* ABF2 Low Light */
      {
         ...
         {1668, 1684, 2676}, /* 12-bit pixels */
         {1.000000f, 0.000000f},

         /* Green channel parameters */
         {1188, 1204, 2676}, /* 12-bit pixels */
         {1.000000f, 0.000000f},
         {1.000000f, 0.000000f},

         /* Blue channel parameters */
         {1668, 1684, 2836}, /* 12-bit pixels */
         {1.000000f, 0.000000f},

         /* Positive table */
         {
            1.000000f, 1.000000f, 1.000000f, 0.981172f,
            0.946001f, 0.905598f, 0.822028f, 0.704485f,
            0.588419f, 0.459806f, 0.358370f, 0.268928f,
            0.186676f, 0.120341f, 0.067543f, 0.015575f
         },
         /* Negative table */
         {
            -0.365602f, -0.386414f, -0.476281f, -0.406957f,
            -0.558191f, -0.571842f, -0.319753f, -0.156181f
         },
      },
      /* ABF2 Normal Light */
      {
         /* Red channel parameters */
         {600, 616, 2648}, /* 12-bit pixels */
         {1.000000f, 0.000000f},

         /* Green channel parameters */
         {584, 600, 2648}, /* 12-bit pixels */
         {1.000000f, 0.000000f},
         {1.000000f, 0.000000f},

         /* Blue channel parameters */
         {616, 632, 2648}, /* 12-bit pixels */
         {1.000000f, 0.000000f},

         /* Positive table */
         {
            1.000000f, 1.000000f, 1.000000f, 1.000000f,
            0.943060f, 0.852711f, 0.762362f, 0.639270f,
            0.552674f, 0.428457f, 0.332163f, 0.252533f,
            0.168977f, 0.099216f, 0.043774f, 0.019980f
         },
         /* Negative table */
         {
            -0.196039f, -0.801470f, -1.000000f, -0.789920f,
            -0.527080f, -0.293695f, -0.271516f, -0.088135f
         },
      },
      /* ABF2 Bright Light */
      {
...
/*********************************************************************/
      ...
      {
         1.8319f,    -0.6746f,    -0.1573f,
         -0.3343f,    1.4040f,    -0.0698f,
         -0.1758f,    -2.4758f,    3.6516f,
         0,    0,    0,
         0
      },
...
/*********************************************************************/
      ...
      /* Saturation: Red - 1.000000, Green - 1.000000, Blue - 1.000000 */
      {
         0.9642f,    -0.4500f,    0.4858f,
         -0.3531f,    1.0055f,    0.3476f,
         -0.4079f,    -1.6846f,    3.0926f,
         0,    0,    0,
         0
      },
      /* D65 Color Correction */
      {
         2.1747f,    -1.2256f,    0.0508f,
         -0.3027f,    1.5709f,    -0.2682f,
         -0.1793f,    -1.2780f,    2.4573f,
         0,    0,    0,
         0
      },
      /* A Color Correction */
      {
         2.0195f,    -0.6564f,    -0.3631f,
         -0.6189f,    1.7626f,    -0.1437f,
         -1.3305f,    -2.3860f,    4.7164f,
         0,    0,    0,
         0
      },
      /* Outdoor Color Correction */
      {
         1.9947f,    -1.2034f,    0.2087f,
         -0.5383f,    1.3677f,    0.1706f,
         -0.3518f,    -1.9726f,    3.3245f,
         0,    0,    0,
         0
      },
...
/*********************************************************************/
      ...
      {
         {
            0, 6, 12, 19, 25, 31, 37, 43, 49, 55, 60, 66, 72, 77, 83, 88,
            93, 98, 104, 109, 113, 118, 123, 128, 132, 137, 141, 146, 150, 154, 158, 162,
            166, 170, 174, 177, 181, 184, 188, 191, 194, 198, 201, 204, 207, 209, 212, 215,
            218, 220, 223, 225, 228, 230, 233, 235, 237, 240, 242, 244, 247, 249, 251, 253
         },
      },
...
/**************************************************************************************/
      ...
      /* Low-Light Trigger Points */
      {
         6.5000000f, /* Gain Start */
         10.0000000f, /* Gain End */
         324, /* Lux Index Start */
         361, /* Lux Index End */
      },
      /* A CCT Trigger */
...
/******************************************************************************/
         ...
         /* Reference Noise */
         {
            /* Noise Profile 1 */
            {
               ...
               {
                  2.546000f, 3.545000f, 5.903000f, 8.407000f, 1.762000f, 2.419000f, 4.485000f, 7.394000f,
                  3.432000f, 7.225000f, 18.120001f, 26.468000f, 1.218000f, 2.631000f, 12.062000f, 24.638000f,
                  1.920000f, 4.040000f, 10.098000f, 18.068001f, 0.745000f, 1.417000f, 6.955000f, 14.798000f
               },
               /* Denoise Scale Y */
               {
            ...
            /* Noise Profile 2 */
            {
               ...
               {
                  3.405000f, 4.575000f, 7.741000f, 9.512000f, 2.371000f, 3.131000f, 6.379000f, 10.301000f,
                  4.208000f, 8.738000f, 22.655001f, 35.148998f, 1.469000f, 3.164000f, 15.646000f, 31.444000f,
                  2.597000f, 5.479000f, 15.649000f, 23.513000f, 0.947000f, 1.869000f, 10.142000f, 26.820000f
               },
               /* Denoise Scale Y */
               {
                  3.000000f, 3.000000f, 3.000000f, 3.000000f
            ...
            /* Noise Profile 3 */
            {
               4.100000f, /* Trigger Value */
               {
                  3.781000f, 5.038000f, 8.234000f, 11.650000f, 2.635000f, 3.465000f, 7.320000f, 9.875000f,
                  4.937000f, 10.772000f, 25.728001f, 42.173000f, 1.773000f, 3.627000f, 18.150999f, 36.972000f,
                  2.800000f, 5.965000f, 15.734000f, 26.301001f, 1.027000f, 2.087000f, 9.796000f, 24.903000f
               },
               /* Denoise Scale Y */
               {
                  3.000000f, 3.000000f, 3.000000f, 3.000000f
            ...
            /* Noise Profile 4 */
            {
               6.400000f, /* Trigger Value */
               {
                  4.739000f, 6.317000f, 11.951000f, 13.353000f, 3.415000f, 4.259000f, 7.264000f, 15.084000f,
                  6.079000f, 13.100000f, 29.020000f, 55.515999f, 2.252000f, 4.889000f, 27.570999f, 52.967999f,
                  3.417000f, 7.035000f, 19.603001f, 34.626999f, 1.249000f, 2.760000f, 12.597000f, 31.740000f
               },
               /* Denoise Scale Y */
               {
                  3.000000f, 3.000000f, 3.000000f, 3.000000f
               ...
               /* Denoise Weight Chroma */
               {
                  0.010000f, 0.010000f, 0.010000f, 0.010000f
               },
               204, /* SW Denosie Edge Threshold Y */
               204, /* SW Denosie Edge Threshold Chroma */
            },
            /* Noise Profile 5 */
            {
               ...
               {
                  4.888000f, 7.218000f, 14.307000f, 21.674000f, 3.345000f, 4.222000f, 12.459000f, 19.538000f,
                  4.809000f, 10.058000f, 27.389000f, 48.381001f, 1.719000f, 3.579000f, 20.493000f, 44.653000f,
                  2.353000f, 4.925000f, 14.533000f, 24.230000f, 0.886000f, 1.587000f, 10.056000f, 22.546000f
               },
               /* Denoise Scale Y */
               {
                  3.000000f, 3.000000f, 3.000000f, 3.000000f
            ...
            /* Noise Profile 6 */
            {
               9.000000f, /* Trigger Value */
               {
                  7.589000f, 9.909000f, 17.284000f, 21.992001f, 4.939000f, 6.952000f, 13.096000f, 23.774000f,
                  3.502000f, 5.245000f, 11.923000f, 15.453000f, 2.238000f, 2.965000f, 8.112000f, 16.055000f,
                  3.721000f, 8.000000f, 20.226999f, 39.993000f, 1.450000f, 2.575000f, 12.668000f, 32.186001f
               },
               /* Denoise Scale Y */
               {
                  3.000000f, 3.000000f, 3.000000f, 3.000000f
...
/*********************************************************************/
   ...
   /* Exposure Table */
   {
      1, /* Use Digital Gain */
      /* Exposure Table */
      362, /* Max Exposure Table Entries Before Digital Gain is Used for EV */
      0, /* Enable Digital Gain for EV Lowlight */
      362, /* Max Exposure Table Entries for EV+2 with digital gain */
      {
         ...
         {1664, 1290},   /* Gain= 6.500   Exposure Index=307   */
         {1665, 1328},  /* Gain= 6.504  Exposure Index=308  */
         {1665, 1368},  /* Gain= 6.504  Exposure Index=309  */
         {1665, 1409},  /* Gain= 6.504  Exposure Index=310  */
         {1664, 1452},  /* Gain= 6.500  Exposure Index=311  */
         {1665, 1495},  /* Gain= 6.504  Exposure Index=312  */
         {1665, 1540},  /* Gain= 6.504  Exposure Index=313  */
         {1664, 1587},  /* Gain= 6.500  Exposure Index=314  */
         {1665, 1634},  /* Gain= 6.504  Exposure Index=315  */
         {1664, 1684},  /* Gain= 6.500  Exposure Index=316  */
         {1664, 1734},  /* Gain= 6.500  Exposure Index=317  */
         {1664, 1786},  /* Gain= 6.500  Exposure Index=318  */
         {1665, 1839},  /* Gain= 6.504  Exposure Index=319  */
         {1664, 1895},  /* Gain= 6.500  Exposure Index=320  */
         {1665, 1951},  /* Gain= 6.504  Exposure Index=321  */
         {1665, 2010},  /* Gain= 6.504  Exposure Index=322  */
         {1664, 2071},  /* Gain= 6.500  Exposure Index=323  */
         {1664, 2133},  /* Gain= 6.500  Exposure Index=324  */
         {1665, 2196},  /* Gain= 6.504  Exposure Index=325  */
         {1664, 2263},  /* Gain= 6.500  Exposure Index=326  */
         {1665, 2330},  /* Gain= 6.504  Exposure Index=327  */
         {1664, 2401},  /* Gain= 6.500  Exposure Index=328  */
         {1664, 2473},  /* Gain= 6.500  Exposure Index=329  */
         {1664, 2547},  /* Gain= 6.500  Exposure Index=330  */
         {1664, 2623},  /* Gain= 6.500  Exposure Index=331  */
         {1664, 2701},  /* Gain= 6.500  Exposure Index=332  */
         {1664, 2782},  /* Gain= 6.500  Exposure Index=333  */
         {1664, 2865},  /* Gain= 6.500  Exposure Index=334  */
         {1665, 2950},  /* Gain= 6.504  Exposure Index=335  */
         {1664, 3040},  /* Gain= 6.500  Exposure Index=336  */
         {1664, 3131},  /* Gain= 6.500  Exposure Index=337  */
         {1664, 3224},  /* Gain= 6.500  Exposure Index=338  */
         {1664, 3320},  /* Gain= 6.500  Exposure Index=339  */
         {1664, 3419},  /* Gain= 6.500  Exposure Index=340  */
         {1664, 3521},  /* Gain= 6.500  Exposure Index=341  */
         {1664, 3626},  /* Gain= 6.500  Exposure Index=342  */
         {1664, 3734},  /* Gain= 6.500  Exposure Index=343  */
         {1667, 3838},  /* Gain= 6.512  Exposure Index=344  */
         {1717, 3838},  /* Gain= 6.707  Exposure Index=345  */
         {1769, 3838},  /* Gain= 6.910  Exposure Index=346  */
         {1822, 3838},  /* Gain= 7.117  Exposure Index=347  */
         {1877, 3838},  /* Gain= 7.332  Exposure Index=348  */
         {1933, 3838},  /* Gain= 7.551  Exposure Index=349  */
         {1991, 3838},  /* Gain= 7.777  Exposure Index=350  */
         {2051, 3838},  /* Gain= 8.012  Exposure Index=351  */
         {2113, 3838},  /* Gain= 8.254  Exposure Index=352  */
         {2176, 3838},  /* Gain= 8.500  Exposure Index=353  */
         {2241, 3838},  /* Gain= 8.754  Exposure Index=354  */
         {2308, 3838},  /* Gain= 9.016  Exposure Index=355  */
         {2377, 3838},  /* Gain= 9.285  Exposure Index=356  */
         {2448, 3838},  /* Gain= 9.563  Exposure Index=357  */
         {2521, 3838},  /* Gain= 9.848  Exposure Index=358  */
         {2597, 3838},  /* Gain=10.145  Exposure Index=359  */
         {2675, 3838},  /* Gain=10.449  Exposure Index=360  */
         {2755, 3838},  /* Gain=10.762  Exposure Index=361  */
      },
   },
