...
/******************************************************************************/
      ...
      /* ABF2 Low Light */
      {
         ...
         {368, 480, 2256}, /* 12-bit pixels */
         {0.80f, 0.000000f},

         /* Green channel parameters */
         {336, 480, 2256}, /* 12-bit pixels */
         {0.70f, 0.000000f},
         {1.000000f, 0.000000f},

         /* Blue channel parameters */
         {352, 480, 2256}, /* 12-bit pixels */
         {0.80f, 0.000000f},
...
/*********************************************************************/
      ...
      /* 7x7 ASF */
      {
         ...
         /* H / Lut1 */
         {
            /* Lowlight */
            {
               0.000000f, 0.000000f, 0.000000f, 0.069994f*1.2, 0.138221f*1.0, 0.202915f*1.2,
               0.262531f*1.2, 0.315468f*1.2, 0.360456f*1.2, 0.396336f*1.2, 0.422170f*1.2, 0.437405f*1.2,
               0.441490f*1.2, 0.434479f*1.2, 0.416484f*1.2, 0.387890f*1.2, 0.349582f*1.2, 0.349582f*1.2,
               0.349582f*1.2, 0.349582f*1.2, 0.349582f*1.2, 0.349582f*1.2, 0.349582f*1.2, 0.349582f*1.2
            },
            /* Normal Light */
            {
               0.000000f, 0.000000f, 0.070374f*1.0, 0.138972f*1.2, 0.204018f*1.3, 0.263958f*1.3,
               0.317194f*1.3, 0.362437f*1.3, 0.398490f*1.3, 0.424509f*1.3, 0.439738f*1.3, 0.443911f*1.3,
               0.436852f*1.3, 0.418736f*1.3, 0.390010f*1.3, 0.351470f*1.3, 0.351470f*1.3, 0.351470f*1.3,
               0.351470f*1.3, 0.351470f*1.3, 0.351470f*1.3, 0.351470f*1.3, 0.351470f*1.3, 0.351470f*1.3
            },
            /* Bright Light */
            {
               0.000000f, 0.122641f*1.0, 0.242187f*1.1, 0.355543f*1.2, 0.460000f*1.2, 0.552787f*1.2,
               0.631582f*1.2, 0.694450f*1.2, 0.739779f*1.2, 0.766345f*1.2, 0.773567f*1.2, 0.761251f*1.2,
               0.729720f*1.2, 0.679684f*1.2, 0.612496f*1.2, 0.612496f*1.2, 0.612496f*1.2, 0.612496f*1.2,
               0.612496f*1.2, 0.612496f*1.2, 0.612496f*1.2, 0.612496f*1.2, 0.612496f*1.2, 0.612496f*1.2
            },
         },
         /* V / Lut2 */
         {
...
/*********************************************************************/
   ...
   /* Exposure Table */
   {
      ...
      426, /* Max Exposure Table Entries for EV+2 with digital gain */
      {
         ...
         {2575, 3324},    /* Gain=10.059    Exposure Index=353    */
         {2652, 3324},    /* Gain=10.359    Exposure Index=354    */
         {2732, 3324},    /* Gain=10.672    Exposure Index=355    */
         {2814, 3324},    /* Gain=10.992    Exposure Index=356    */
         {2898, 3324},    /* Gain=11.320    Exposure Index=357    */
         {2985, 3324},    /* Gain=11.660    Exposure Index=358    */
         {3072, 3324},    /* Gain=12.000    Exposure Index=359    */
         {3073, 3423},    /* Gain=12.004    Exposure Index=360    */
         {3073, 3526},    /* Gain=12.004    Exposure Index=361    */
         {3073, 3632},    /* Gain=12.004    Exposure Index=362    */
         {3072, 3742},    /* Gain=12.000    Exposure Index=363    */
         {3072, 3854},    /* Gain=12.000    Exposure Index=364    */
         {3072, 3969},    /* Gain=12.000    Exposure Index=365    */
         {3072, 4088},    /* Gain=12.000    Exposure Index=366    */
         {3072, 4210},    /* Gain=12.000    Exposure Index=367    */
         {3072, 4336},    /* Gain=12.000    Exposure Index=368    */
         {3072, 4466},    /* Gain=12.000    Exposure Index=369    */
         {3073, 4599},    /* Gain=12.004    Exposure Index=370    */
         {3072, 4738},    /* Gain=12.000    Exposure Index=371    */
         {3072, 4880},    /* Gain=12.000    Exposure Index=372    */
         {3072, 5026},    /* Gain=12.000    Exposure Index=373    */
         {3072, 5176},    /* Gain=12.000    Exposure Index=374    */
         {3072, 5331},    /* Gain=12.000    Exposure Index=375    */
         {3073, 5490},    /* Gain=12.004    Exposure Index=376    */
         {3072, 5656},    /* Gain=12.000    Exposure Index=377    */
         {3072, 5825},    /* Gain=12.000    Exposure Index=378    */
         {3072, 5999},    /* Gain=12.000    Exposure Index=379    */
         {3072, 6178},    /* Gain=12.000    Exposure Index=380    */
         {3072, 6363},    /* Gain=12.000    Exposure Index=381    */
         {3072, 6553},    /* Gain=12.000    Exposure Index=382    */
         {3072, 6749},    /* Gain=12.000    Exposure Index=383    */
         {3072, 6951},    /* Gain=12.000    Exposure Index=384    */
         {3072, 7159},    /* Gain=12.000    Exposure Index=385    */
         {3072, 7373},    /* Gain=12.000    Exposure Index=386    */
         {3072, 7594},    /* Gain=12.000    Exposure Index=387    */
         {3072, 7821},    /* Gain=12.000    Exposure Index=388    */
         {3072, 8055},    /* Gain=12.000    Exposure Index=389    */
         {3072, 8296},    /* Gain=12.000    Exposure Index=390    */
         {3072, 8544},    /* Gain=12.000    Exposure Index=391    */
         {3072, 8800},    /* Gain=12.000    Exposure Index=392    */
         {3072, 9064},    /* Gain=12.000    Exposure Index=393    */
         {3072, 9335},    /* Gain=12.000    Exposure Index=394    */
         {3072, 9615},    /* Gain=12.000    Exposure Index=395    */
         {3072, 9903},    /* Gain=12.000    Exposure Index=396    */
         {3142, 9972},    /* Gain=12.273    Exposure Index=397    */
         {3236, 9972},    /* Gain=12.641    Exposure Index=398    */
         {3333, 9972},    /* Gain=13.020    Exposure Index=399    */
         {3433, 9972},    /* Gain=13.410    Exposure Index=400    */
         {3536, 9972},    /* Gain=13.813    Exposure Index=401    */
         {3642, 9972},    /* Gain=14.227    Exposure Index=402    */
         {3751, 9972},    /* Gain=14.652    Exposure Index=403    */
         {3864, 9972},    /* Gain=15.094    Exposure Index=404    */
         {3980, 9972},    /* Gain=15.547    Exposure Index=405    */
         {4099, 9972},    /* Gain=16.012    Exposure Index=406    */
         {4222, 9972},    /* Gain=16.492    Exposure Index=407    */
         {4349, 9972},    /* Gain=16.988    Exposure Index=408    */
         {4479, 9972},    /* Gain=17.496    Exposure Index=409    */
         {4613, 9972},    /* Gain=18.020    Exposure Index=410    */
         {4751, 9972},    /* Gain=18.559    Exposure Index=411    */
         {4894, 9972},    /* Gain=19.117    Exposure Index=412    */
         {5041, 9972},    /* Gain=19.691    Exposure Index=413    */
         {5192, 9972},    /* Gain=20.281    Exposure Index=414    */
         {5348, 9972},    /* Gain=20.891    Exposure Index=415    */
         {5508, 9972},    /* Gain=21.516    Exposure Index=416    */
         {5673, 9972},    /* Gain=22.160    Exposure Index=417    */
         {5843, 9972},    /* Gain=22.824    Exposure Index=418    */
         {6018, 9972},    /* Gain=23.508    Exposure Index=419    */
         {6199, 9972},    /* Gain=24.215    Exposure Index=420    */
         {6385, 9972},    /* Gain=24.941    Exposure Index=421    */
         {6577, 9972},    /* Gain=25.691    Exposure Index=422    */
         {6774, 9972},    /* Gain=26.461    Exposure Index=423    */
         {6977, 9972},    /* Gain=27.254    Exposure Index=424    */
         {7168, 9972},    /* Gain=28.000    Exposure Index=425    */
         {7383, 9972},    /* Gain=28.840    Exposure Index=426    */
         {7604, 9972},    /* Gain=29.703    Exposure Index=427    */
         {7832, 9972},    /* Gain=30.594    Exposure Index=428    */
         {8067, 9972},    /* Gain=31.512    Exposure Index=429    */
         {8309, 9972},    /* Gain=32.457    Exposure Index=430    */
         {8558, 9972},    /* Gain=33.430    Exposure Index=431    */
         {8815, 9972},    /* Gain=34.434    Exposure Index=432    */
         {9079, 9972},    /* Gain=35.465    Exposure Index=433    */
         {9351, 9972},    /* Gain=36.527    Exposure Index=434    */
         {9632, 9972},    /* Gain=37.625    Exposure Index=435    */
         {9921, 9972},    /* Gain=38.754    Exposure Index=436    */
         {10219, 9972},    /* Gain=39.918    Exposure Index=437    */
         {10526, 9972},    /* Gain=41.117    Exposure Index=438    */
         {10842, 9972},    /* Gain=42.352    Exposure Index=439    */
         {11167, 9972},    /* Gain=43.621    Exposure Index=440    */
         {11502, 9972},    /* Gain=44.930    Exposure Index=441    */
         {11847, 9972},    /* Gain=46.277    Exposure Index=442    */
         {12202, 9972},    /* Gain=47.664    Exposure Index=443    */
         {12568, 9972},    /* Gain=49.094    Exposure Index=444    */
         {12945, 9972},    /* Gain=50.566    Exposure Index=445    */
         {13333, 9972},    /* Gain=52.082    Exposure Index=446    */
         {13733, 9972},    /* Gain=53.645    Exposure Index=447    */
         {14145, 9972},    /* Gain=55.254    Exposure Index=448    */
         {14569, 9972},    /* Gain=56.910    Exposure Index=449    */
         {15006, 9972},    /* Gain=58.617    Exposure Index=450    */
         {15456, 9972},    /* Gain=60.375    Exposure Index=451    */
         {15920, 9972},    /* Gain=62.188    Exposure Index=452    */
         {16398, 9972},    /* Gain=64.055    Exposure Index=453    */
         {16890, 9972},    /* Gain=65.977    Exposure Index=454    */
         {17397, 9972},    /* Gain=67.957    Exposure Index=455    */
         {17919, 9972},    /* Gain=69.996    Exposure Index=456    */
         {18457, 9972},    /* Gain=72.098    Exposure Index=457    */
         {19011, 9972},    /* Gain=74.262    Exposure Index=458    */
         {19581, 9972},    /* Gain=76.488    Exposure Index=459    */
         {20168, 9972},    /* Gain=78.781    Exposure Index=460    */
         {20773, 9972},    /* Gain=81.145    Exposure Index=461    */
         {21396, 9972},    /* Gain=83.578    Exposure Index=462    */
         {22038, 9972},    /* Gain=86.086    Exposure Index=463    */
         {22699, 9972},    /* Gain=88.668    Exposure Index=464    */
         {23380, 9972},    /* Gain=91.328    Exposure Index=465    */
         {24081, 9972},    /* Gain=94.066    Exposure Index=466    */
         {24803, 9972},    /* Gain=96.887    Exposure Index=467    */
         {25547, 9972},    /* Gain=99.793    Exposure Index=468    */
         {26313, 9972},    /* Gain=102.785    Exposure Index=469    */
         {27102, 9972},    /* Gain=105.867    Exposure Index=470    */
         {27915, 9972}    /* Gain=109.043    Exposure Index=471    */
      },
   },
...
/*********************************************************************/
   ...
   0.200000f, /* Max Snapshot Exposure Time Allowed */
...
/******************************************************************************/
      ...
      56, /* Enable */
      411, /* Min Time */
      420.000000f, /* Intersect Time Gain */
