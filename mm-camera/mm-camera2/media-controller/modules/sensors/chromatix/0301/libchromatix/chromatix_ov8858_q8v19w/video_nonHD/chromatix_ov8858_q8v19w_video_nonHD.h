...
/*********************************************************************/
   ...
   {
      1, /* Use Digital Gain */
      350, /* Max Exposure Table Entries for EV0 */
      1, /* Enable Digital Gain for EV Lowlight */
      406, /* Max Exposure Table Entries for EV+2 with digital gain */
      {
         ...
         {2109, 1248},	/* Gain= 8.238	Exposure Index=313	*/
         {2172, 1248},	/* Gain= 8.484	Exposure Index=314	*/
         {2237, 1248},	/* Gain= 8.738	Exposure Index=315	*/
         {2304, 1248},	/* Gain= 9.000	Exposure Index=316	*/
         {2373, 1248},	/* Gain= 9.270	Exposure Index=317	*/
         {2444, 1248},	/* Gain= 9.547	Exposure Index=318	*/
         {2517, 1248},	/* Gain= 9.832	Exposure Index=319	*/
         {2593, 1248},	/* Gain=10.129	Exposure Index=320	*/
         {2671, 1248},	/* Gain=10.434	Exposure Index=321	*/
         {2751, 1248},	/* Gain=10.746	Exposure Index=322	*/
         {2834, 1248},	/* Gain=11.070	Exposure Index=323	*/
         {2919, 1248},	/* Gain=11.402	Exposure Index=324	*/
         {3007, 1248},	/* Gain=11.746	Exposure Index=325	*/
         {3097, 1248},	/* Gain=12.098	Exposure Index=326	*/
         {3190, 1248},	/* Gain=12.461	Exposure Index=327	*/
         {3286, 1248},	/* Gain=12.836	Exposure Index=328	*/
         {3385, 1248},	/* Gain=13.223	Exposure Index=329	*/
         {3487, 1248},	/* Gain=13.621	Exposure Index=330	*/
         {3592, 1248},	/* Gain=14.031	Exposure Index=331	*/
         {3700, 1248},	/* Gain=14.453	Exposure Index=332	*/
         {3811, 1248},	/* Gain=14.887	Exposure Index=333	*/
         {3925, 1248},	/* Gain=15.332	Exposure Index=334	*/
         {4043, 1248},	/* Gain=15.793	Exposure Index=335	*/
         {4164, 1248},	/* Gain=16.266	Exposure Index=336	*/
         {4289, 1248},	/* Gain=16.754	Exposure Index=337	*/
         {4418, 1248},	/* Gain=17.258	Exposure Index=338	*/
         {4551, 1248},	/* Gain=17.777	Exposure Index=339	*/
         {4688, 1248},	/* Gain=18.313	Exposure Index=340	*/
         {4829, 1248},	/* Gain=18.863	Exposure Index=341	*/
         {4974, 1248},	/* Gain=19.430	Exposure Index=342	*/
         {5123, 1248},	/* Gain=20.012	Exposure Index=343	*/
         {5277, 1248},	/* Gain=20.613	Exposure Index=344	*/
         {5435, 1248},	/* Gain=21.230	Exposure Index=345	*/
         {5598, 1248},	/* Gain=21.867	Exposure Index=346	*/
         {5766, 1248},	/* Gain=22.523	Exposure Index=347	*/
         {5939, 1248},	/* Gain=23.199	Exposure Index=348	*/
         {6117, 1248},	/* Gain=23.895	Exposure Index=349	*/
         {6301, 1248},	/* Gain=24.613	Exposure Index=350	*/
         {6490, 1248},	/* Gain=25.352	Exposure Index=351	*/
         {6685, 1248},	/* Gain=26.113	Exposure Index=352	*/
         {6886, 1248},	/* Gain=26.898	Exposure Index=353	*/
         {7093, 1248},	/* Gain=27.707	Exposure Index=354	*/
         {7306, 1248},	/* Gain=28.539	Exposure Index=355	*/
         {7525, 1248},	/* Gain=29.395	Exposure Index=356	*/
         {7751, 1248},	/* Gain=30.277	Exposure Index=357	*/
         {7984, 1248},	/* Gain=31.188	Exposure Index=358	*/
         {8192, 1248},	/* Gain=32.000	Exposure Index=359	*/
         {8438, 1248},	/* Gain=32.961	Exposure Index=360	*/
         {8691, 1248},	/* Gain=33.949	Exposure Index=361	*/
         {8952, 1248},	/* Gain=34.969	Exposure Index=362	*/
         {9221, 1248},	/* Gain=36.020	Exposure Index=363	*/
         {9498, 1248},	/* Gain=37.102	Exposure Index=364	*/
         {9783, 1248},	/* Gain=38.215	Exposure Index=365	*/
         {10076, 1248},	/* Gain=39.359	Exposure Index=366	*/
         {10378, 1248},	/* Gain=40.539	Exposure Index=367	*/
         {10689, 1248},	/* Gain=41.754	Exposure Index=368	*/
         {11010, 1248},	/* Gain=43.008	Exposure Index=369	*/
         {11340, 1248},	/* Gain=44.297	Exposure Index=370	*/
         {11680, 1248},	/* Gain=45.625	Exposure Index=371	*/
         {12030, 1248},	/* Gain=46.992	Exposure Index=372	*/
         {12391, 1248},	/* Gain=48.402	Exposure Index=373	*/
         {12763, 1248},	/* Gain=49.855	Exposure Index=374	*/
         {13146, 1248},	/* Gain=51.352	Exposure Index=375	*/
         {13540, 1248},	/* Gain=52.891	Exposure Index=376	*/
         {13946, 1248},	/* Gain=54.477	Exposure Index=377	*/
         {14364, 1248},	/* Gain=56.109	Exposure Index=378	*/
         {14795, 1248},	/* Gain=57.793	Exposure Index=379	*/
         {15239, 1248},	/* Gain=59.527	Exposure Index=380	*/
         {15696, 1248},	/* Gain=61.313	Exposure Index=381	*/
         {16167, 1248},	/* Gain=63.152	Exposure Index=382	*/
         {16652, 1248},	/* Gain=65.047	Exposure Index=383	*/
         {17152, 1248},	/* Gain=67.000	Exposure Index=384	*/
         {17667, 1248},	/* Gain=69.012	Exposure Index=385	*/
         {18197, 1248},	/* Gain=71.082	Exposure Index=386	*/
         {18743, 1248},	/* Gain=73.215	Exposure Index=387	*/
         {19305, 1248},	/* Gain=75.410	Exposure Index=388	*/
         {19884, 1248},	/* Gain=77.672	Exposure Index=389	*/
         {20481, 1248},	/* Gain=80.004	Exposure Index=390	*/
         {21095, 1248},	/* Gain=82.402	Exposure Index=391	*/
         {21728, 1248},	/* Gain=84.875	Exposure Index=392	*/
         {22380, 1248},	/* Gain=87.422	Exposure Index=393	*/
         {23051, 1248},	/* Gain=90.043	Exposure Index=394	*/
         {23743, 1248},	/* Gain=92.746	Exposure Index=395	*/
         {24455, 1248},	/* Gain=95.527	Exposure Index=396	*/
         {25189, 1248},	/* Gain=98.395	Exposure Index=397	*/
         {25945, 1248},	/* Gain=101.348	Exposure Index=398	*/
         {26723, 1248},	/* Gain=104.387	Exposure Index=399	*/
         {27525, 1248},	/* Gain=107.520	Exposure Index=400	*/
         {28351, 1248},	/* Gain=110.746	Exposure Index=401	*/
         {29202, 1248},	/* Gain=114.070	Exposure Index=402	*/
         {30078, 1248},	/* Gain=117.492	Exposure Index=403	*/
         {30980, 1248},	/* Gain=121.016	Exposure Index=404	*/
         {31909, 1248}	/* Gain=124.645	Exposure Index=405	*/
      },
   },
...
/*********************************************************************/
   ...
   284, /* AEC Indoor Index */
   184, /* AEC Outdoor Index */
