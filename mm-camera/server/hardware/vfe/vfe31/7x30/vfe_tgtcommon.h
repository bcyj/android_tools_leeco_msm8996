...
#define VFE_PIXEL_IF_PARALLEL 1
#define VFE_PIXEL_IF_MIPI 3
#define VFE_PIXEL_IF_MIPI_1 3
...
typedef struct VFE_CFGPacked {
  ...
  uint32_t  /* reserved */       :  1;
  uint32_t  pixelIfInputSelect   :  2;  /* disabled, camif, MDDI, or MIPI */
  uint32_t  /* reserved */       :  2;
  ...
  uint32_t  pbusClkOffEnable     :  1;  /* should = 0  */
  uint32_t  pbusClkIdleEnable    :  1;  /* should = 0  */
  uint32_t  /* reserved */       :  6;
