...
#include "vfe.h"
/*===========================================================================
 * FUNCTION    - vfe_clamp_ops_init -
 *
 * DESCRIPTION:
 *==========================================================================*/
vfe_status_t vfe_clamp_ops_init(void *mod)
{
  clamp_mod_t *pmod = (clamp_mod_t *)mod;
  memset(pmod, 0 , sizeof(clamp_mod_t));
  pmod->ops.init = vfe_clamp_init;
  pmod->ops.update = NULL;
  pmod->ops.trigger_update = NULL;
  pmod->ops.config = vfe_clamp_config;
  pmod->ops.enable = vfe_clamp_enable;
  ...
  pmod->ops.deinit = vfe_clamp_deinit;
  return VFE_SUCCESS;
}

/*===========================================================================
 * FUNCTION    - vfe_clamp_ops_deinit -
 *
 * DESCRIPTION:
 *==========================================================================*/
