...
/* AWB Reference Points w/HW */
{
   /* D65 AWB Reference Point w/HW */
   {
      0.552000f,	/* R/G ratio */
      1.008000f,	/* B/G ratio */
      0.953000f,	/* Red Gain Adjust */
      1.022000f	/* Blue Gain Adjust */
   },
   /* Shade AWB Reference Point w/HW */
   {
      0.506000f,	/* R/G ratio */
      1.121000f,	/* B/G ratio */
      0.952000f,	/* Red Gain Adjust */
      1.024000f	/* Blue Gain Adjust */
   },
   /* A AWB Reference Point w/HW */
   {
      0.915000f,	/* R/G ratio */
      0.454000f,	/* B/G ratio */
      0.926000f,	/* Red Gain Adjust */
   ...
   /* D50 AWB Reference Point w/HW */
   {
      0.598000f,	/* R/G ratio */
      0.846000f,	/* B/G ratio */
      0.954000f,	/* Red Gain Adjust */
      1.021000f	/* Blue Gain Adjust */
   },
...
/* Exposure Table */
{
   1, /* Use Digital Gain */
   /* Exposure Table */
   347, /* Max Exposure Table entries */
   {
      ...
      {2048, 834},	/* Gain= 8.000	Exposure Index=299	*/
      {2048, 859},	/* Gain= 8.000	Exposure Index=300	*/
      {2048, 884},	/* Gain= 8.000	Exposure Index=301	*/
      {2048, 910},	/* Gain= 8.000	Exposure Index=302	*/
      {2048, 937},	/* Gain= 8.000	Exposure Index=303	*/
      {2048, 965},	/* Gain= 8.000	Exposure Index=304	*/
      {2048, 993},	/* Gain= 8.000	Exposure Index=305	*/
      {2048, 1022},	/* Gain= 8.000	Exposure Index=306	*/
      {2048, 1052},	/* Gain= 8.000	Exposure Index=307	*/
      {2048, 1083},	/* Gain= 8.000	Exposure Index=308	*/
      {2048, 1115},	/* Gain= 8.000	Exposure Index=309	*/
      {2048, 1148},	/* Gain= 8.000	Exposure Index=310	*/
      {2048, 1182},	/* Gain= 8.000	Exposure Index=311	*/
      {2048, 1217},	/* Gain= 8.000	Exposure Index=312	*/
      {2048, 1253},	/* Gain= 8.000	Exposure Index=313	*/
      ...
      {2048, 2844},	/* Gain= 8.000	Exposure Index=341	*/
      {2048, 2929},	/* Gain= 8.000	Exposure Index=342	*/
      {2048, 3016},	/* Gain= 8.000	Exposure Index=343	*/
      {2048, 3106},	/* Gain= 8.000	Exposure Index=344	*/
      {2048, 3199},	/* Gain= 8.000	Exposure Index=345	*/
      {2048, 3294}	/* Gain= 8.000	Exposure Index=346	*/
   },
},
