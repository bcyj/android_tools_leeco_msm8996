...
static int start_test(char *buf, uint32_t size, hash_map < string, string > &params) {
    ...
    char *args[12] = { (char *) BIN_GARDEN_APP, (char *) "-z", (char *) "0", (char *) "-u", (char *) "0",
        (char *) "-q", (char *) "0", (char *) "-A", (char *) params["SVs"].c_str(), (char *) "-B",
        (char *) params["SNR"].c_str(), NULL
    };
    execmd.cmd = BIN_GARDEN_APP;
    execmd.params = args;
    execmd.pid = -1;
    ...
    while(*p != '\0') {         /*print every line of scan result information */
        ...
        *ptr = '\0';
        ...
        if(ptr != NULL) {
            snprintf(tmp, sizeof(tmp), "GPS test pass\n %s", ptr);
