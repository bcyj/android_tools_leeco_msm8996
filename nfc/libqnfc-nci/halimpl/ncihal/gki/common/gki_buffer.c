...
*******************************************************************************/
#if GKI_BUFFER_DEBUG
void GKI_freebuf_debug (void * p_buf, const char * _function_, int _line_)
#else
...
#if GKI_BUFFER_DEBUG
    LOGD("GKI_freebuf() freeing, %x, %x, func:%s(line=%d) at func:%s(line=%d)", p_buf, p_hdr, p_hdr->_function, p_hdr->_line, _function_ ,_line_ );
#endif
