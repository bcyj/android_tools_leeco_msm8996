...
// <DTA>
#define LLCP_ECHO_CO_SAP            0x12    /* SAP reserved for echoserver connection oriented */
#define LLCP_ECHO_CL_SAP            0x11    /* SAP reserved for echoserver connectionless */
#define LLCP_ECHO_CL_C_SAP          0x21    /* SAP reserved for dta connectionless client */
// </DTA>
...
// <DTA>
LLCP_API extern UINT8 LLCP_RegisterCLClient (UINT8           link_type,
                                             UINT8           sap,
