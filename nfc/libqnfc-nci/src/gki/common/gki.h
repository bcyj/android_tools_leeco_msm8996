...
#if GKI_BUFFER_DEBUG
#define GKI_freebuf(void )    GKI_freebuf_debug(void , __FUNCTION__, __LINE__)
GKI_API extern void   GKI_freebuf_debug (void *, const char *, int);
#else
...
#endif
GKI_API extern UINT8    GKI_getbufstatus (void *);
...
*/
#if GKI_BUFFER_DEBUG
#define GKI_enable()    GKI_enable_debug( __FUNCTION__, __LINE__)
GKI_API extern void   GKI_enable_debug (const char *, int);
#else
GKI_API extern void   GKI_enable(void);
#endif
#if GKI_BUFFER_DEBUG
#define GKI_disable()    GKI_disable_debug( __FUNCTION__, __LINE__)
GKI_API extern void   GKI_disable_debug (const char *, int);
#else
