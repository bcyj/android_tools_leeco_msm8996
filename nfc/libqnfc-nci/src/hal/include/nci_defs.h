...
#define NCI_MAX_VSC_SIZE        0x0400 /* PPSE control CMD is the MAX size NCI cmd, its max size 1k - 0x400 */
...
#define NFCC_FEATURES_OCTET_FOURTH  4   /*4th byte of the NFCC features per spec*/
#define ORANGE_ROUTE_BIT            1   /*bit position starting from 0 of orange routing in NFCC_FEATURES_OCTET_FOURTH byte*/
...
/* OID: Opcode Identifier (byte 1) for NFCC Storage */
#define NCI_OID_NFCC_STORE  0x10

/* OID: Opcode Identifier (byte 1) for GENERIC */
#define NCI_OID_GENERIC     0x01
...
#define NCI_MSG_RF_PRESENCE_CHECK       12 /* QNCI_FEATURE_ISODEP_PRESENCE */
 ...
 **********************************************/
#define NCI_MSG_PROP_MEMACCESS          0x00
#define NCI_MSG_PROP_GENERIC            0x01
#define NCI_MSG_PROP_ROMINFO            0x02
#define NCI_MSG_PROP_SLEEP              0x03
#define NCI_MSG_PROP_MULTISE            0x11
/*NCI MULTI SE CONTROL SUB CMD */
#define NCI_GET_MAX_PPSE_SZ             0x00
#define NCI_SET_PPSE_RSP                0x01
#define NCI_CLR_PRV_PPSE_RSP            0x02
#define NCI_SET_DEFAULT_PPSE            0x03
/*NCI MULTI SE CONTROL SUB CMD */

#define NCI_MSG_PROP_GENERIC_SUBCMD_UI_STATE          0x11

#define NCI_PROP_HCI_UI_STATE_UNKNOWN                 0x00
#define NCI_PROP_HCI_UI_STATE_AVAILABLE               0x01
#define NCI_PROP_HCI_UI_STATE_LOCKED_NOT_NOTIFIABLE   0x02
#define NCI_PROP_HCI_UI_STATE_LOCKED_NOTIFIABLE       0x03
#define NCI_PROP_HCI_UI_STATE_UNLOCKED_NOT_NOTIFIABLE 0x04

#define NCI_PROP_NFCC_UI_STATE_OFF      0x00
#define NCI_PROP_NFCC_UI_STATE_UNLOCKED 0x01
#define NCI_PROP_NFCC_UI_STATE_LOCKED   0x02

/*NCI HD's HAL CMD */
#define NCI_MSG_PROP_GENERIC_HAL_CMD           0xF1
#define NCI_PROP_HAL_POLLING_IN_LOCKED         0x01
#define NCI_PROP_HAL_ENABLE_POLL               0x01
#define NCI_PROP_HAL_DISABLE_POLL              0x00
...
#define NCI_PROTOCOL_18092_ACTIVE       0x83
#endif
...
#define NCI_PROTOCOL_15693              0x80
#endif
...
#define NCI_EE_TRIG_CONNECTIVITY        0x11
...
#define NCI_PARAM_CON_DISCOVERY_PARAM   0x02
...
/* proprietary NCI_PARAMS */
#define NCI_PARAM_LA_SFGI                   0xA0
#define NCI_PARAM_LA_DID_REQUIRED           0xA1
#define NCI_PARAM_LBPRIME_PAT_IN            0xA2
#define NCI_PARAM_LBPRIME_DAT_OUT           0xA3
#define NCI_PARAM_NFCEE_RESCAN_INTERuAL     0xA4

#define NCI_PARAM_PI_TX_BIT_RATE            0xA5
#define NCI_PARAM_PI_RX_BIT_RATE            0xA6
#define NCI_PARAM_LI_TX_BIT_RATE            0xA7
#define NCI_PARAM_LI_RX_BIT_RATE            0xA8
#define NCI_PARAM_LI_SAME_BIT_RATE          0xA9

#define NCI_PARAM_PA_FSDI                   0xAA
#define NCI_PARAM_PB_FSDI                   0xAB
#define NCI_PARAM_LA_FSCI                   0xAC
#define NCI_PARAM_LB_FSCI                   0xAD
#define NCI_PARAM_LB_MBLI                   0xAE

#define NCI_PARAM_LI_FWIMAX                 0xAF
#define NCI_PARAM_PI_STATIC_DID             0xB0
#define NCI_PARAM_PI_N_RETRANSMIT           0xB1
#define NCI_PARAM_PI_N_RETRY_ACK            0xB2
#define NCI_PARAM_PI_N_RETRY_NAK            0xB3

#define NCI_PARAM_PI_N_RETRY_WTX            0xB4
#define NCI_PARAM_PI_N_RETRY_DESELECT       0xB5
#define NCI_PARAM_LI_WTXM                   0xB6
#define NCI_PARAM_PN_STATIC_DID             0xB7
#define NCI_PARAM_PN_N_RETRY_NACK           0xB8

#define NCI_PARAM_PN_N_RETRY_ATN            0xB9
#define NCI_PARAM_PN_N_TO_MAX               0xBA
#define NCI_PARAM_PN_N_RETRY_WUP            0xBB
#define NCI_PARAM_PN_N_RETRY_ATR            0xBC
#define NCI_PARAM_LN_RTOX                   0xBD

#define NCI_PARAM_SLPB_COLLISION_RESOLUTION 0xBE
#define NCI_PARAM_NFC_MODE                  0xBF
#define NCI_PARAM_EMVCO_HW_BUG_WORKAROUND   0xC0
#define NCI_PARAM_KOVIO_BIT_REVERSE_FRAME   0xC1
#define NCI_PARAM_KOVIO_REACTIVATION_TIME   0xC2

#define NCI_PARAM_LISTEN_TECHNOLOGY_LOCKING         0xC3
#define NCI_PARAM_LN_NFCID2                         0xC4
#define NCI_PARAM_ISO_GATE_CONFIG                   0xC5
#define NCI_PARAM_SWP_DEACTIVATE_TO_DIS             0xC6
#define NCI_PARAM_T2T_ENCRYPTION_DEASSERT_TIMEOUT   0xC7

#define NCI_PARAM_PF_BAIL_OUT                       0xC8
#define NCI_PARAM_MIFARE_DESFIRE_ACTIVATION         0xC9
#define NCI_PARAM_ANTICOLLISION_ASK_FOR_BCC         0xCA
#define NCI_PARAM_LA_NAD_REQUIRED                   0xCB
#define NCI_PARAM_PN_ATR_RES_CHANGEABLE_PARAMS      0xCC

#define NCI_PARAM_ACTIVITY_VERSION          0xCD
#define NCI_PARAM_DIGITAL_PROTOCOL_VERSION  0xCE
#define NCI_PARAM_PN_CON_BITR_NFC_DEP_I2T   0xCF
#define NCI_PARAM_PN_CON_BITR_NFC_DEP_T2I   0xD0
#define NCI_PARAM_PI_N_RETRY_RATS           0xD1

#define NCI_PARAM_PI_N_RETRY_PPS            0xD2
#define NCI_PARAM_PI_N_RETRY_ATTRIB         0xD3
#define NCI_PARAM_PN_N_RETRY_PSL            0xD4
#define NCI_PARAM_CON_DEVICES_LIMIT_NFC_A   0xD5
#define NCI_PARAM_CON_DEVICES_LIMIT_NFC_B   0xD6

#define NCI_PARAM_CON_DEVICES_LIMIT_NFC_F   0xD7
#define NCI_PARAM_CON_DEVICES_LIMIT_NFC_V   0xD8
#define NCI_PARAM_LN_RTOX_SEND_DIVIDER      0xD9
#define NCI_PARAM_DTA_MODE                  0xDA
#define NCI_PARAM_LI_FWIMIN                 0xDB

#define NCI_PARAM_VCD_BIT_RATE              0xDC
#define NCI_PARAM_VCD_MATCH_DSFID_ZERO      0xDD
#define NCI_PARAM_TX_RX_FRM_CTRL            0xDE
...
/* Mifare Classic : CRC and Parity disable/enable(in nfcc) parameter IDs*/
#define NCI_PARAM_ID_OFF_CRC_PARITY_IN_NFCC        0xDE
#define DISABLE_CRC_PARITY_ADDITION_IN_NFCC        0x0F
#define ENABLE_CRC_PARITY_ADDITION_IN_NFCC         0x00
#define CRC_PARITY_PARAM_LEN                       0x01
typedef struct
{
    UINT16              addr;
    UINT8               len;
