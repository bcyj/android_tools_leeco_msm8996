...
enum
{
    ...
    NFA_DM_API_GET_ROUTING_EVT,
    NFA_DM_API_DTA_SET_PATTERN_NUM,
    NFA_DM_MAX_EVT
};
...
/* data type for NFA_DM_API_GET_ROUTING_EVT */
typedef struct
{
    BT_HDR              hdr;
} tNFA_DM_API_GET_ROUTING;
...
#ifdef DTA // <DTA>
/*data type for NFA_DM_API_DTA_SET_PATTERN_NUM*/
typedef struct
{
    BT_HDR            hdr;
    UINT8             length;
    UINT8             *p_data;
} tNFA_DM_DTA_SET_PATTERN;
#endif // <DTA>
...
typedef union
{
    ...
    #ifdef DTA // <DTA>
    tNFA_DM_DTA_SET_PATTERN         dta_pattern;        /* NFA_DM_API_DTA_SET_PATTERN_NUM          */
    #endif // <DTA>
    tNFA_DM_API_GET_ROUTING         getrouting;          /* NFA_DM_API_GET_ROUTING_EVT          */
} tNFA_DM_MSG;
...
/* NFCC chip versions*/
#define NFCC_CHIP_VERSION_3                     0x03
#define NFCC_CHIP_VERSION_2                     0x02
...
typedef struct
{
   ...
   /* NFCC chip version*/
    ...
    /* NFCC orange rout Flag to indicate if it is supports routing */
    BOOLEAN                     orange_route;
    BOOLEAN                     resend_screen; /*  QNCI_FEATURE_UI_SCREEN_ERR_HANDLE */
    BOOLEAN                     poll_locked_mode;
    UINT8                       req_screen_off; /*  QNCI_FEATURE_UI_SCREEN_ERR_HANDLE */
