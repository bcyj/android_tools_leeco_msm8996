...
enum
{
    ...
    NFA_HCI_API_RECONNECT_EVT,                                    /* reconnect to NFCEE */
...
#define NFA_HCI_LAST_API_EVENT      NFA_HCI_API_RECONNECT_EVT
...
/* data type for NFA_HCI_API_RECONNECT_EVT */
typedef struct
{
    BT_HDR              hdr;
    tNFA_HANDLE         hci_handle;
    tNFA_HANDLE         ee_handle;
} tNFA_HCI_API_RECONNECT;
...
typedef union
{
    ...
    tNFA_HCI_API_RECONNECT              reconnect;                      /* reconnect to NFCEE */
...
typedef struct
{
    ...
    BOOLEAN                         reconnecting;                       /* true if reconnecting is in progress */
    tNFA_HANDLE                     reconnect_ee_handle;                /* currently connected or reconnecting NFCEE */
    tNFA_HANDLE                     reconnect_hci_handle;               /* app handle of requesting reconnection */
