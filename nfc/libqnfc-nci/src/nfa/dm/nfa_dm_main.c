...
const tNFA_DM_ACTION nfa_dm_action[] =
{
    ...
    nfa_dm_get_routing,                 /* NFA_DM_API_GET_ROUTING_EVT           */
    #ifdef DTA // <DTA>
    nfa_dm_dta_set_pattern             /* NFA_DM_API_DTA_SET_PATTERN_NUM       */
    #endif // <DTA>
};
...
static char *nfa_dm_evt_2_str (UINT16 event)
{
    ...
    case NFA_DM_API_REG_VSC_EVT:
        return "NFA_DM_API_REG_VSC_EVT";

    case NFA_DM_API_SEND_VSC_EVT:
        return "NFA_DM_API_SEND_VSC_EVT";
    ...
    #ifdef DTA // <DTA>
    case NFA_DM_API_DTA_SET_PATTERN_NUM:
        return "NFA_DM_API_DTA_SET_PATTERN_NUM";
    #endif // <DTA>
    }

    return "ERROR: UNKNOWN OR VENDOR SPECIFIC EVENT !!!";
}
