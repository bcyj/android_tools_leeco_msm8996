...
/*******************************************************************************
**
** Function         NFA_EeGetMaxLmrtSize
**
** Description      This function is called to get the maximum
**                  Listen Mode Routing Table Size.
**                  This is a blocking function, since the info is available in
**                  after CORE_INIT_RSP.
**
** Returns          Max Listen More Routing Table size
**
*******************************************************************************/
UINT16 NFA_EeGetMaxLmrtSize(void)
{
  return NFC_GetLmrtSize();
}
