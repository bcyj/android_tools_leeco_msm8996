...
#define NFA_HCI_RECONNECT_EVT                   0x17    /* reconnect to other NFCEE                     */
...
/* Data for NFA_HCI_RECONNECT_EVT */
typedef struct
{
    tNFA_STATUS     status;                             /* Status of reconnection */
} tNFA_HCI_RECONNECT_EVT;
...
typedef union
{
    ...
    tNFA_HCI_RECONNECT_EVT          reconnected;    /* NFA_HCI_RECONNECT_EVT          */
} tNFA_HCI_EVT_DATA;
...
**
*******************************************************************************/
NFC_API extern tNFA_STATUS NFA_HciReconnect (tNFA_HANDLE hci_handle, tNFA_HANDLE ee_handle);
