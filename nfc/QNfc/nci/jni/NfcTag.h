...
public:
    ...
    **
    ** Description:     Get the RF Interaface of the current tag.
    **
    ** Returns:         RF Interface
    **
    *******************************************************************************/
    tNFA_INTF_TYPE getRfInterface ();

    /*******************************************************************************
    **
    ** Function:        setRfInterface
    **
    ** Description:     Set the RF Interaface of the current tag.
    **
    ** Returns:         void
    **
    *******************************************************************************/
    void setRfInterface (tNFA_INTF_TYPE type);
    ...
    **
    *******************************************************************************/
    void SendNfccInfo(struct nfc_jni_native_data *nat,UINT8* nfcc_info_data, UINT8 len);
