...
public class NativeNfcSecureElement {
    ...
    private native int doNativeOpenSecureElementConnection(int nfceeId);

    public int doOpenSecureElementConnection(int nfceeId) {
        mPrefsEditor.putBoolean(PREF_SE_WIRED, true);
        mPrefsEditor.apply();

        return doNativeOpenSecureElementConnection(nfceeId);
    }
