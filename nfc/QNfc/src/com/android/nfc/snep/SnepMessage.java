...
public final class SnepMessage {
    ...
    // <DTA>
    public static SnepMessage getNotFoundResponse(NdefMessage ndef) {
        if (ndef == null) {
            return new SnepMessage(VERSION, RESPONSE_NOT_FOUND, 0, 0, null);
        } else {
            return new SnepMessage(VERSION, RESPONSE_NOT_FOUND, ndef.toByteArray().length, 0, ndef);
        }
    }
    // </DTA>
