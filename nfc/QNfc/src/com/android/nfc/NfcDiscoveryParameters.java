...
public final class NfcDiscoveryParameters {
    ...
    public static class Builder {
        ...
        public NfcDiscoveryParameters.Builder setEnableOffHostRouting(String offHostRouting) {
            mParameters.mOffHostRouting = offHostRouting;
            return this;
        }
    ...
    private String  mOffHostRouting = null;
    ...
    public String getOffHostRouting() {
        return mOffHostRouting;
    }

    public boolean shouldEnableDiscovery() {
        return mTechMask != 0 || mEnableHostRouting || (mOffHostRouting != null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        boolean isSameOffHostRouting;
        if (mOffHostRouting == null) {
            if (params.mOffHostRouting == null)
                isSameOffHostRouting = true;
            else
                isSameOffHostRouting = false;
        } else {
            isSameOffHostRouting = mOffHostRouting.equals(params.mOffHostRouting);
        }
    ...
    public String toString() {
        ...
        sb.append("mOffHostRouting: " + mOffHostRouting);
