...
GENERAL DESCRIPTION
  ...
  $Header: //source/qcom/qct/interfaces/qmi/wms/main/latest/src/wireless_messaging_service_v01.c#32 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
static const uint8_t wms_indication_register_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_indication_register_req_msg_v01, reg_transport_layer_mwi_info_events) - QMI_IDL_OFFSET8(wms_indication_register_req_msg_v01, reg_transport_layer_mwi_info_events_valid)),
  0x15,
   QMI_IDL_GENERIC_1_BYTE,
...
static const uint8_t wms_get_indication_register_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wms_get_indication_register_resp_msg_v01, reg_transport_layer_mwi_info_events) - QMI_IDL_OFFSET8(wms_get_indication_register_resp_msg_v01, reg_transport_layer_mwi_info_events_valid)),
  0x15,
   QMI_IDL_GENERIC_1_BYTE,
...
static const qmi_idl_service_message_table_entry wms_service_command_messages_v01[] = {
  ...
  {QMI_WMS_INDICATION_REGISTER_REQ_V01, QMI_IDL_TYPE16(0, 58), 24},
...
static const qmi_idl_service_message_table_entry wms_service_response_messages_v01[] = {
  ...
  {QMI_WMS_GET_INDICATION_REGISTER_RESP_V01, QMI_IDL_TYPE16(0, 69), 31},
