...
public class ListSubscribePollingTask extends AsyncTask<Void, Integer, Integer> {
    final String TAG = "ListSubscribePollingTask";

    Context mContext;
    ProgressDialog dialog;

    ListSubscribePollingTask me;

    public ListSubscribePollingTask() {}

    public ListSubscribePollingTask(Context appContext) {
    ...
    private Integer sendListSubscribePollingRequest(ArrayList<String> contactList) {
        ...
        return p.imsp_send_subscribe_req(SubscriptionType.POLLING,
                contactList);
    }
