...
public class Ringer {
    ...
    /**
     * Initialize the singleton Ringer instance. This is only done once, at
     * startup, from PhoneApp.onCreate().
     */
    ...
    private Ringer(Context context) {
        ...
        // We don't rely on getSystemService(Context.VIBRATOR_SERVICE) to make
        // sure this
    ...
    /**
     * After a radio technology change, e.g. from CDMA to GSM or vice versa, the
     * Context of the Ringer has to be updated. This is done by that function.
     *
    ...
    /**
     * Sets the ringtone uri in preparation for ringtone creation in
                ...
                public void handleMessage(Message msg) {
                    ...
                    case PLAY_RING_ONCE:
                        ...
                        if (mRingtone == null && !hasMessages(STOP_RING)) {
                            ...
                            if (DBG)
                                log("creating ringtone: " + mCustomRingtoneUri);
                    ...
                    case STOP_RING:
                        ...
                        if (r != null) {
                            ...
                            if (DBG)
                                log("- STOP_RING with null ringtone!  msg = "
                                        + msg);
                        }
                        getLooper().quit();
                        break;
