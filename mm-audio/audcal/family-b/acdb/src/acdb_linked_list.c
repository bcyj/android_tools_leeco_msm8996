...
===========================================================================*/
/* $Header: //source/qcom/qct/multimedia2/Audio/audcal4/acdb_sw/main/latest/acdb/src/acdb_linked_list.c#10 $ */
/*===========================================================================
	...
	)
{
	...
	if (pTblOnHeap != NULL && pKey != NULL)
	{
		...
		if (pTblOnHeap == NULL)
		{
			AcdbDynamicTblNodeTypeEx *pTblOnHeap = (AcdbDynamicTblNodeTypeEx *)ACDB_MALLOC(sizeof(AcdbDynamicTblNodeTypeEx));
			pTblOnHeap->pTblHead = NULL;
			pTblOnHeap->pTblTail = NULL;
		}
