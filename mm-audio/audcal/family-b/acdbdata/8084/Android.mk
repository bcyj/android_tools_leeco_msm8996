...
LOCAL_MODULE_TAGS       := optional
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_ETC)/acdbdata/MTP/apq8084-tomtom-mtp-snd-card/
LOCAL_SRC_FILES         := MTP/apq8084-tomtom-mtp-snd-card/Bluetooth_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_ETC)/acdbdata/MTP/apq8084-tomtom-mtp-snd-card/
LOCAL_SRC_FILES         := MTP/apq8084-tomtom-mtp-snd-card/General_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_ETC)/acdbdata/MTP/apq8084-tomtom-mtp-snd-card/
LOCAL_SRC_FILES         := MTP/apq8084-tomtom-mtp-snd-card/Global_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_ETC)/acdbdata/MTP/apq8084-tomtom-mtp-snd-card/
LOCAL_SRC_FILES         := MTP/apq8084-tomtom-mtp-snd-card/Handset_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_ETC)/acdbdata/MTP/apq8084-tomtom-mtp-snd-card/
LOCAL_SRC_FILES         := MTP/apq8084-tomtom-mtp-snd-card/Hdmi_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_ETC)/acdbdata/MTP/apq8084-tomtom-mtp-snd-card/
LOCAL_SRC_FILES         := MTP/apq8084-tomtom-mtp-snd-card/Headset_cal.acdb
include $(BUILD_PREBUILT)
...
LOCAL_MODULE_CLASS      := ETC
LOCAL_MODULE_PATH       := $(TARGET_OUT_ETC)/acdbdata/MTP/apq8084-tomtom-mtp-snd-card/
LOCAL_SRC_FILES         := MTP/apq8084-tomtom-mtp-snd-card/Speaker_cal.acdb
include $(BUILD_PREBUILT)
