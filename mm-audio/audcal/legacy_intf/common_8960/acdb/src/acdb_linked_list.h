...
==============================================================================*/
/* $Header: //source/qcom/qct/multimedia2/Audio/audcal2/common/8k_PL/acdb/rel/4.2/src/acdb_linked_list.h#1 $ */
/*===========================================================================
...
typedef struct AcdbDynamicChangedDeviceTypeStruct{
	uint8_t *pDevice;
	struct AcdbDynamicChangedDeviceTypeStruct *pNext;
}AcdbDynamicChangedDeviceType;

typedef struct AcdbDynamicChangedDeviceTblStruct{
	AcdbDynamicChangedDeviceType *pDevIDsHead;
	AcdbDynamicChangedDeviceType *pDevIDsTail;
}AcdbDynamicChangedDeviceTblType;
