...
========================================================================== */
/* $Header: //source/qcom/qct/multimedia2/Audio/audcal2/common/8k_PL/acdb/rel/4.2/src/acdb_parser.h#1 $ */
...
typedef struct _AcdbParseGlbDefsTblDataType
{
   uint32_t nParamId;
   uint32_t nBufferSize;
   uint8_t *pBuffer;
}
AcdbParseGlbDefsTblDataType;

typedef struct _AcdbParseAdieSidetoneDataType
{
   uint32_t    nTxDeviceId;
   uint32_t    nRxDeviceId;
   uint32_t    nModuleId;
