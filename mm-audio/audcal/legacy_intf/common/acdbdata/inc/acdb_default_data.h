...
typedef struct _AcdbDataDeviceInfoType {
   const uint32_t ulDeviceId;
   const AcdbDeviceInfoType *pDeviceInfo;
} AcdbDataDeviceInfoType;

typedef struct _AcdbDataDeviceInfo2Type {
   const uint32_t ulDeviceId;
   const AcdbDeviceInfo2Type *pDeviceInfo;
} AcdbDataDeviceInfo2Type;

typedef struct _AcdbDataDeviceInfo3Type {
   const uint32_t ulDeviceId;
   const AcdbDeviceInfo3Type *pDeviceInfo;
} AcdbDataDeviceInfo3Type;

typedef struct _AcdbDataDeviceInfo4Type {
   const uint32_t ulDeviceId;
   const AcdbDeviceInfo4Type *pDeviceInfo;
} AcdbDataDeviceInfo4Type;
...
/* ---------------------------------------------------------------------------
 * ACDBDATA_GET_DEV_INFO_TABLE Declarations and Documentation
 *--------------------------------------------------------------------------- */

/**
   @fn   AcdbDataIoctl (ACDBDATA_GET_DEV_INFO_TABLE, ...)
   ...
   @return  The return values of this function are:
         ...
         ACDB_PARMNOTFOUND: When the key is not found in the table.
*/
#define ACDBDATA_GET_DEV_INFO_TABLE                         0xACDB0020
...
/**
   ...
   struct AudPricCmnTopologyListType {
      uint32_t nCount;
...
/**
   ...
   struct AudPricStrmTopologyListType {
      uint32_t nCount;
