...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/qmimsgs.apss.tn/3.0/csd/src/core_sound_driver_v01.c#8 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
static const qmi_idl_service_message_table_entry csd_service_command_messages_v01[] = {
  ...
  {QMI_CSD_IOCTL_VM_CMD_SET_HDVOICE_MODE_REQ_V01, QMI_IDL_TYPE16(0, 267), 18}
};
...
static const qmi_idl_service_message_table_entry csd_service_response_messages_v01[] = {
  ...
  {QMI_CSD_IOCTL_VM_CMD_SET_HDVOICE_MODE_RESP_V01, QMI_IDL_TYPE16(0, 268), 28}
};
