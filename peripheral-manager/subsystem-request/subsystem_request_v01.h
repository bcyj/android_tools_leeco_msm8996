...
#define SSREQ_V01_IDL_MINOR_VERS 0x01
...
typedef enum {
  ...
  SSREQ_QMI_CLIENT_INSTANCE_APSS_V01 = 0,
  SSREQ_QMI_CLIENT_INSTANCE_MPSS_V01 = 1,
  SSREQ_QMI_CLIENT_INSTANCE_WCNSS_V01 = 2,
  SSREQ_QMI_CLIENT_INSTANCE_ADSP_V01 = 3,
  SSREQ_QMI_CLIENT_INSTANCE_VPU_V01 = 4,
  SSREQ_QMI_CLIENT_INSTANCE_MDM_V01 = 5,
  SSREQ_QMI_CLIENT_INSTANCE_QSC_V01 = 6,
...
typedef enum {
  ...
  SSREQ_QMI_REQUEST_SERVICED_V01 = 0,
  SSREQ_QMI_REQUEST_NOT_SERVICED_V01 = 1,
...
/** @addtogroup ssreq_qmi_messages
    @{
  */
/** Request Message; Shutdown the complete system. */
typedef struct {
...
/** @addtogroup ssreq_qmi_messages
    @{
  */
/** Response Message; Shutdown the complete system. */
typedef struct {
...
/** @addtogroup ssreq_qmi_messages
    @{
  */
/** Indication Message; Communicates that the system shutdown request serviced or not. */
typedef struct {
...
/** @addtogroup ssreq_qmi_messages
    @{
  */
/** Indication Message; Communicates that the system restart request is serviced or not. */
typedef struct {
...
/** @addtogroup ssreq_qmi_messages
    @{
  */
/** Request Message; Restart the subsystem(peripheral). */
typedef struct {
...
/** @addtogroup ssreq_qmi_messages
    @{
  */
/** Response Message; Restart the subsystem(peripheral). */
typedef struct {
...
/** @addtogroup ssreq_qmi_messages
    @{
  */
/** Indication Message; Communicates that the subsystem restart request is serviced or not. */
typedef struct {
