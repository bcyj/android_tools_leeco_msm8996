...
public class Handset extends Activity {

	String mAudiofilePath;
	static String TAG = "Handset";
	...
	void replay() throws IllegalArgumentException, IllegalStateException,
			IOException {
		final TextView mTextView = (TextView) findViewById(R.id.handset_hint);
		mTextView.setText(getString(R.string.handset_playing));
		...
		mMediaPlayer.setOnCompletionListener(new OnCompletionListener() {
			...
			public void onCompletion(MediaPlayer mPlayer) {
				...
				final TextView mTextView = (TextView) findViewById(R.id.handset_hint);
				mTextView.setText(getString(R.string.handset_replay_end));
				showConfirmDialog();
	...
	void showConfirmDialog() {
		...
		new AlertDialog.Builder(mContext)
				.setTitle(getString(R.string.handset_confirm))
	...
	void bindView() {
		...
		recordButton = (Button) findViewById(R.id.handset_start);
		stopButton = (Button) findViewById(R.id.handset_stop);
		final TextView mTextView = (TextView) findViewById(R.id.handset_hint);
		mTextView.setText(getString(R.string.handset_to_record));
		...
		recordButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!mAudioManager.isWiredHeadsetOn()) {
					...
					mTextView.setText(getString(R.string.handset_recording));
					try {
		...
		stopButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (isRecording) {
					...
					showWarningDialog(getString(R.string.handset_record_first));
			}
		});
	}
