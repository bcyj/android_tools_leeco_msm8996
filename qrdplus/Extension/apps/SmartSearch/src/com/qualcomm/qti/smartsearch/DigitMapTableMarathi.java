...
/**
 * <p>
 * Implements the Marathi-characters to digits map.
 * </p>
 */
public class DigitMapTableMarathi extends DigitMapTableLatin {

    private static DigitMapTableMarathi sInstance = null;

    private static final char[][] EXTEND_MARATHI_TABLE = {
            // number 0
            {
                    0x0966
            },
    ...
    public static DigitMapTableMarathi getInstance() {
        if (sInstance == null) {
            sInstance = new DigitMapTableMarathi();
        }
        return sInstance;
    }

    private DigitMapTableMarathi() {
    }
    ...
    public String toDigits(char c) {
        ...
        for (int i = 0; i < KEY_NUM; i++) {
            if (contains(EXTEND_MARATHI_TABLE[i], c)) {
                idx = i;
                break;
            }
        }
