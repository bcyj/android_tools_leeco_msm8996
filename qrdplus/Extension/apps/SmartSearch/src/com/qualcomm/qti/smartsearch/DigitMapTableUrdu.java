...
/**
 * <p>
 * Implements the Urdu-characters to digits map.
 * </p>
 */
public class DigitMapTableUrdu extends DigitMapTableLatin{


    private static DigitMapTableUrdu sInstance = null;

    private static final char[][] EXTEND_URDU_TABLE = {
        // number 0
        {
            0x0660
        },
    ...
    public static DigitMapTableUrdu getInstance() {
        if (sInstance == null) {
            sInstance = new  DigitMapTableUrdu();
        }
        return sInstance;
    }

    private  DigitMapTableUrdu() {
    }
    ...
    public String toDigits(char c) {
        ...
        for (int i = 0; i < KEY_NUM; i++) {
            if (contains(EXTEND_URDU_TABLE[i], c)) {
                idx = i;
                break;
            }
        }
