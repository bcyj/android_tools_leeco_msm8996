...
public class VCardEntryConstructor implements VCardInterpreter {
    ...
    public VCardEntryConstructor(String sourceCharset,
            ...
            int vcardType,
            Account account, boolean pimUse) {
        this(sourceCharset, targetCharset, strictLineBreakParsing, vcardType, account);
        mPimUse = pimUse;
    }
    ...
    /**
     * Called when the parse failed between {@link #startEntry()} and
     * {@link #endEntry()}.
     */
    public void clear() {
    ...
    public void endProperty() {
        // zhl add
        if (mPimUse)
            mCurrentContactStruct.pimAddProperty(mCurrentProperty);
        else
            // add enc
    ...
    public void propertyValues(List<String> values) {
        ...
        for (final String value : values) {
            mCurrentProperty.addToPropertyValueList(
                    handleOneValue(value, mCharsetForDecodedBytes, encoding));
        }
    }
