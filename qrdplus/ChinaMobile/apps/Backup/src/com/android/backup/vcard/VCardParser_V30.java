...
public class VCardParser_V30 extends VCardParser_V21 {
    ...
    /**
     * @param strictParsing when true, this object throws VCardException when
     *            the vcard is not valid from the view of vCard 3.0
     *            specification (defined in RFC 2426). Note that this class is
     *            not fully yet for being used with this flag and may not notice
     *            invalid line(s).
    ...
    /**
     * vCard 3.0 defines param = param-name "=" param-value *("," param-value)
     * param-name = iana-token / x-name param-value = ptext / quoted-string
    ...
    /**
     * ESCAPED-CHAR = "\\" / "\;" / "\," / "\n" / "\N") ; \\ encodes \, \n or \N
     * encodes newline ; \; encodes ;, \, encodes , Note: Apple escapes ':' into
     * '\:' while does not escape '\'
     */
    @Override
