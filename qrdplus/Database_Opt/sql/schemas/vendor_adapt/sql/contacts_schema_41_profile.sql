...
-- make_contacts_schema_41_profile.pl by copying the contents of
-- the contacts database and replacing certain names.
...
CREATE UNIQUE SEQUENCE raw_contacts_id_seq AS BIGINT initial_value=9223372034707292160 in profile_db;
...
CREATE UNIQUE SEQUENCE packages_id_seq as BIGINT in profile_db;
...
CREATE UNIQUE SEQUENCE mimetypes_id_seq as BIGINT in profile_db;
...
-- NEXT_SEQUENCE_IS_PROFILE_VALUE
create unique sequence data_id_seq AS BIGINT initial_value=9223372034707292160 in profile_db;
...
create unique sequence data_usage_stat_id_seq AS BIGINT in profile_db;
...
-- NEXT_SEQUENCE_IS_PROFILE_VALUE
create unique sequence directories_id_seq AS BIGINT initial_value=9223372034707292160 in profile_db;
...
-- NEXT_SEQUENCE_IS_PROFILE_VALUE
CREATE UNIQUE SEQUENCE contacts_id_seq AS BIGINT initial_value=9223372034707292160 in profile_db;
...
-- NEXT_SEQUENCE_IS_PROFILE_VALUE
CREATE UNIQUE SEQUENCE photo_files_id_seq AS BIGINT initial_value=9223372034707292160 in profile_db;
...
-- NEXT_SEQUENCE_IS_PROFILE_VALUE
CREATE UNIQUE SEQUENCE groups_id_seq AS BIGINT initial_value=9223372034707292160 in profile_db;
...
CREATE UNIQUE SEQUENCE agg_exceptions_seq AS BIGINT in profile_db;
...
-- NEXT_SEQUENCE_IS_PROFILE_VALUE
CREATE UNIQUE SEQUENCE calls_id_seq AS BIGINT initial_value=9223372034707292160 in profile_db;
...
-- NEXT_SEQUENCE_IS_PROFILE_VALUE
CREATE UNIQUE SEQUENCE stream_item_photos_id_seq AS BIGINT initial_value=9223372034707292160 in profile_db;
...
-- NEXT_SEQUENCE_IS_PROFILE_VALUE
CREATE UNIQUE SEQUENCE stream_items_id_seq AS BIGINT initial_value=9223372034707292160 in profile_db;
...
CREATE UNIQUE SEQUENCE voicemail_status_id_seq as BIGINT in profile_db;
...
create unique sequence accounts_id_seq in profile_db;
...
CREATE UNIQUE SEQUENCE sync_state_seq in profile_db;
...
CREATE UNIQUE SEQUENCE v1_settings_seq as BIGINT in profile_db;
...
-- NEXT_ZERO_IS_PROFILE_VALUE 
    1               AS raw_contact_is_user_profile,
