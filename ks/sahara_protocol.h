 ...
 * ==========================================================================================
 *   $Header: //source/qcom/qct/core/storage/tools/kickstart/common/kickstart/kickstart/sahara_protocol.h#1 $
...
typedef struct {
    ...
    // Flag to allow sending sahara reset.
    int allow_sahara_reset;
