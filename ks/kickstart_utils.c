 ...
 *  for storing image id and file mapping
 * ==========================================================================================
 *   $Header: //source/qcom/qct/core/storage/tools/kickstart/common/kickstart/kickstart/kickstart_utils.c#2 $
...
bool init_search_path_list() {
	return add_search_path("/firmware/image/");
}
...
const char* find_file(const char *filename)
{
	...
	dbg(LOG_ERROR, "Cound't find the file, returning NULL");
	return NULL;
}
